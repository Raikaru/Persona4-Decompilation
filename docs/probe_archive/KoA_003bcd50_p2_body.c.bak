/* Lane KoA probe 2 for func_003bcd50: object 200B/window 208B, normalized_diff 28.
 Residual: missing the trailing nop before `return` and the final function-end
 nop; otherwise the loop body, guard, and jtbl call now match retail. Body is
 identical to B3B except `(s64)0 < count` guard and `count` local forcing the
 jtbl argument reload. */
...
s32 func_003bcd50(s32 arg0, s32 arg1, s32 arg2, s32 arg3) {
    ...
    *(u8 **)(work + 4) = jtbl_008873E8[0](count * 0x10, 0x3011F);
    i = 0;
