/* object 668 / window 672 / normalized_diff 5 / differing byte offsets 0x1FE, 0x200, 0x202, 0x206, 0x20E. Direct residual classification: ordinary integer align-up materialisation (retail's $v1/$v0 register-class/lifetime pair versus candidate's $v0 reuse), not COP2/VU0 and not COP1 MAC. Tested the >>6 correction plus additional lifetime/declaration/type/register spellings; none changed nd or closed the five-byte cluster. Probe list: corrected func_0044ea90 declaration from typed (u8 *, s32) to old-style extern void func_0044ea90(); measured no change; archive body retained as best result. Prior lane exhausted signed/unsigned parameter and align-local widths, declaration order, pointer-slot and array forms, loop/guard polarity, arithmetic/cast spellings, local reuse/liveness, argument types, pragmas, and a 600-second permuter run. */
