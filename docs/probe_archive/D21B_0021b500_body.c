/* object 300B; retail window 304B; normalized_diff 8; differing offsets 0x3C, 0x40, 0x7C, 0x80, 0xBC, 0xC0, 0xFC, 0x100; retail-only tail pad 0x12C; best legal plain-C body; residual is repeated OR/MT1 register coloring. */
