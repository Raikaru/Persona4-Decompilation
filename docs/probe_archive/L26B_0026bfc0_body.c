/* 2026-09-01 remeasure: initial aggregate form object 460B, window 464B, normalized_diff 4; fndiff residual words 0x70/0x78 (retail lwc1/swc1 versus mwcc's second aggregate ld/sd), while opt_propagation off also fixes the earlier 0x80/0x88/0x8C axis3 scheduling differences. The retail window contains the confirmed COP1 accumulator chain adda.s/msub.s, and the final plain-C source reproduces that chain exactly. Final closure uses opt_propagation off, a block-scoped axis2p, and axis2_xy/axis2_z field temporaries. Ruled-out probes: axis2 direct-width scalar copy (nd 68), direct axis3 loads (nd 69), axis3 field-staging, separate axis3 locals, reversed axis3 source order, uniform typed component access, comma-sequenced loads, named axis3 pointer, aggregate axis3 copy, optimization_level 1 (92 differing words, 484B object), and permute.py seed 0x260812 (1817 compiles/185s, best score 9); no volatile or inline asm used. */
