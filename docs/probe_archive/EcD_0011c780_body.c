/* func_0011c780; object 428B; retail window 432B; best normalized_diff 6 (fndiff differing words, including relocation-owned word); visible differing offsets 0x130, 0x138, 0x154, 0x158, 0x15C; relocation-owned GPREL offset 0x06C (iGpffff8094). Best candidate uses #pragma opt_propagation off, which fixes the retail lh/lwc1 prologue order; no pragma was retained after fallback. Hex-Rays and Ghidra agree on the clamp/interpolation, two FMA chains, byte interpolation, 0x4F000000 conversion guard, and final flag clear. Ruled out: direct duplicated stores, ternary/shared-mask variants, signed/unsigned/char output locals, declaration permutations and first-use reorderings, raw-first and inline conversion forms, pointer aliases, integer-parameter aliases, register-qualified parameters, four-argument ABI declarations, comparison polarity/spelling variants, no-op liveness reservations, union guard constant, opt_common_subs, opt_rebuildconditionals, schedule, no_branch_likely, and optimization_level 1 probes.
