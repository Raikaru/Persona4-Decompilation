/* PTR u_long128->u8* lever (even lane 2026-09-17, on WIDE base): 317 differing words (probe_variants) over 136 fnalign edits (+3 reloc-only), retail 367 vs object 367 exact (frame 0xF0). Base WIDE 321/139/375 (frame 0x100), base G 331/154/381. WALL remains slot-layout + scheduling (u8 groups alias, byte-copy interleave vs batched, var_16 4-instr vs clean pair, u8 arg1 andi). Repro: python3 tools/probe_variants.py src/Event/Fcl/y_fclCombineDraw.c func_003212e0 --candidate PTR=docs/probe_archive/PTR_003212e0_body.c ; python3 tools/fnalign.py src/Event/Fcl/y_fclCombineDraw.c func_003212e0 --candidate docs/probe_archive/PTR_003212e0_body.c --quiet . Banked as guarded floor per 3% rule (exact size, whatever score). */
