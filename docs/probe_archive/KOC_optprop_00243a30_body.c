// FUN_00243A30
/* measured: opt_propagation off keeps the count==0 assert and forces the u16 loop counter mask, matching retail's $s3/i layout. */
#pragma push
...
/* measured: close opt_propagation scope after func_00243a30. */
#pragma pop
