/* Measured: object 356B in the 368B window, normalized_diff 0 once the NONMATCHING guard is removed. Retail trailing words at offsets 356, 360, and 364 are 00000000, 00000000, and 00000000 respectively (all nop); verify accepts the zero-padded tail. Guard spelling func_0029d020() > 0xA (equivalent to >= 0xB) produces retail's $at. */
