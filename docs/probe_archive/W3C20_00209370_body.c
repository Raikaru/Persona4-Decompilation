...
void func_00209370(u8 *arg0, u8 *arg1, f32 *arg2)
{
    s16 temp_2_2;
    u8 *temp_2;
    ...
    if (*(u16 *)arg1 == 2) {
        ...
        func_00201650(temp_2, 9, 0x4A, 93.0f, 314.0f,
                      0x1B, 0x1B, 0x1B, 0xFF);
        func_00206dd0(arg1, arg0, func_002055d0, arg2[0], arg2[1]);
    } else {
        func_00201650(temp_2, 9, 0x23, 75.0f, 317.0f,
                      0x1B, 0x1B, 0x1B, 0xFF);
    }
    D_00887300[0](6, 1);
    func_002019e0(temp_2, 0x42F00000);
    func_00201650(temp_2, 9, 0x39, 8.0f, 297.0f,
                  0x1B, 0x1B, 0x1B, 0xFF);
    D_00887300[0](6, 0);
