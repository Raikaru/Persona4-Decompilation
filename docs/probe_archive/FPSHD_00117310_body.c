/* Historical recovery candidate retained after the exact production
 * reconstruction landed in src/promoted/shdPersona.c (59d190c7).
 * Measurements and rejected hypotheses below describe that earlier work. */
