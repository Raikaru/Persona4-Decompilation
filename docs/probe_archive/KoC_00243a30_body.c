// FUN_00243A30 archive (wave Ko lane KoC, killed by provider rate limit mid-work; live state at cutoff, MISMATCH nd343 708/688).
        if ((*(u16 *)arg0 & 4)) {
            s32 partyOffset;
u16 func_00243a30(u8 *arg0, s32 *arg1)
{
    ...
    if (result == 0) {
        ...
        if ((s32)((func_003b7060() % 200U) & 0xFFFF) >= (s32)count) {
            goto done;
        }
        if (count == 0) {
