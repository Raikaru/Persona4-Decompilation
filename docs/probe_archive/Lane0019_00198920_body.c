...
s32 func_00193d90(u8 *arg0, s32 arg1)
{
    ...
    case 3:
        ...
        for (; i < 4; i++) {
            node = *(u8 **)(base + i * 8 + 0x19C);
            for (; node != NULL; node = *(u8 **)(node + 0x7C)) {
                if (id == (*(s64 *)(node + 0x58) & 0x3FFFFFFFFFFFFFFFLL) &&
                    (*(u8 *)(node + 0x47) & 0x20) != 0) {
                    goto found_3;
                }
            }
...
found_5:
    ...
    case 6:
        ...
        for (; i < 4; i++) {
            node = *(u8 **)(base + i * 8 + 0x19C);
            for (; node != NULL; node = *(u8 **)(node + 0x7C)) {
                if (id == (*(s64 *)(node + 0x60) & 0x3FFFFFFFFFFFFFFFLL) &&
                    (*(u8 *)(node + 0x47) & 0x20) != 0) {
                    goto found_6;
                }
            }
...
found_11:
        if (node != NULL) {
            callback = *(s32 (**)(s32, s32, s64))(node + 0x74);
            if (callback != NULL) {
                result = callback(*(s32 *)(node + 0x78), base, id);
            } else {
                result = 0;
            }
        }
...
// FUN_00198920
void func_00198920(u8 *arg0, s16 arg1, u16 arg2, f32 fparg0, u16 arg4)
{
    extern s32 func_00232710();
    extern void func_00479940();
    extern void func_0047a120();
    extern void func_0047a150();
    f32 var_f0;
    f32 var_f0_2;
    s32 temp_16;
    s32 temp_22;
    ...
    *(s16 *)(arg0 + 0x9DC) = arg4;
    if ((*(s32 *)(arg0 + 0x98) & 2) != 0) {
        temp_22 = (u16)arg1;
        *(s16 *)(arg0 + 0x9DA) = arg1;
        var_18 = (u16)func_001990d0(arg0, temp_22);
        if (var_18 < (u16)*(u16 *)(arg0 + 0x9E4)) {
            temp_4_3 = (u8 *)(*(s32 *)(arg0 + 0x9F8) + (s32)(var_18 * 0xA));
            *(f32 *)(arg0 + 0x9E0) =
                fparg0 * ((f32)*(s16 *)(temp_4_3 + 2) / 100.0f);
        } else {
            *(f32 *)(arg0 + 0x9E0) = 1.0f;
        }
        temp_16 = (u16)arg4;
        if ((temp_16 != 5) && (temp_16 != 4) && (temp_16 != 3) &&
            (temp_16 != 2) && (temp_16 != 0)) {
            var_2 = 1;
        } else {
            var_2 = 0;
        ...
        if ((*(u16 *)(arg0 + 0x9D8) & 0x10) ||
            (((temp_4 = *(s32 *)(arg0 + 0xA64)) != 0) &&
             (func_00232710(temp_4, 0x100) != 0))) {
        ...
        func_00479940(*(u8 **)(arg0 + 0xA00), 0, (s16)var_18,
                      arg2, var_17);
        func_0047a0e0(*(u8 **)(arg0 + 0xA00), 0,
                      *(f32 *)(arg0 + 0x9E0));
        temp_2 = (u8 *)func_0019eda0(arg0, temp_22);
        *(f32 *)(arg0 + 0x80) = (f32)*(s16 *)(temp_2 + 0);
        *(f32 *)(arg0 + 0x84) = (f32)*(s16 *)(temp_2 + 2);
        *(f32 *)(arg0 + 0x88) = (f32)*(s16 *)(temp_2 + 4);
        temp_3_3 = *(u16 *)(temp_2 + 6);
        if ((s16)temp_3_3 >= 0) {
            var_f0 = (f32)temp_3_3;
        } else {
            var_f0 = 2.0f *
                     (f32)((temp_3_3 >> 1) | (temp_3_3 & 1));
        }
        *(f32 *)(arg0 + 0x8C) = var_f0;
        temp_3_4 = *(u16 *)(temp_2 + 8);
        if ((s16)temp_3_4 >= 0) {
            var_f0_2 = (f32)temp_3_4;
        } else {
            var_f0_2 = 2.0f *
                       (f32)((temp_3_4 >> 1) | (temp_3_4 & 1));
        }
        *(f32 *)(arg0 + 0x90) = var_f0_2;
        if ((temp_19 != 0x10) && (temp_19 != 8)) {
            *(u16 *)(arg0 + 0x9D8) =
                (u16)(*(u16 *)(arg0 + 0x9D8) & 0xFFFB);
        } else {
            temp_4_2 = (u16)var_18;
            if (temp_4_2 < *(u16 *)(arg0 + 0x9E4)) {
                temp_5 = temp_4_2 * 0xA;
                temp_4_3 =
                    (u8 *)(*(s32 *)(arg0 + 0x9F8) + temp_5);
                if ((*(s16 *)(temp_4_3 + 0) >= 0) &&
                    (*(s16 *)(temp_4_3 + 4) > 0)) {
                    *(u16 *)(arg0 + 0x9D8) =
                        (u16)(*(u16 *)(arg0 + 0x9D8) | 4);
                    *(s16 *)(arg0 + 0x9E6) =
                        *(s16 *)(temp_4_3 + 0);
                    *(s16 *)(arg0 + 0x9E8) =
                        *(s16 *)(temp_4_3 + 4);
        ...
        if (temp_16 == 0) {
            if (temp_19 == 4) {
                *(s16 *)(arg0 + 0x9EE) = 0;
            } else if ((temp_19 == 20) || (temp_19 == 23) ||
                       (temp_19 == 22) || (temp_19 == 11) ||
                       (temp_19 == 9) || (temp_19 == 12) ||
                       (temp_19 == 8) || (temp_19 == 2)) {
                *(s16 *)(arg0 + 0x9EE) = 0;
            } else {
                temp_5_2 = (u16)var_18;
                if (temp_5_2 < *(u16 *)(arg0 + 0x9E4)) {
                    *(s16 *)(arg0 + 0x9EE) =
                        *(s16 *)(*(s32 *)(arg0 + 0x9F8) +
                                 temp_5_2 * 0xA + 8);
                } else {
...
s32 func_0019bf80(u8 *arg0) {
    ...
    if (func_0047e6f0(*(u8 **)(temp_3 + 0xA00) + 0x2D0) != 0) {
        return 1;
    }
block_6:
    return 0;
