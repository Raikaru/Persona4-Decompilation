Skipped: closest generated C candidate retained below as a full-file snapshot; target remains INCLUDE_ASM because scoped normalized_diff was nonzero.
...
extern void func_003e0870(void *arg0, void *arg1, s32 arg2, f32 farg0);
...
void func_002a03b0(u8 *arg0) {
    ...
    func_0025e9e0(0.0f,0.0f,0.0f,0xFFFFFF,0xFF,0xA4,uGpffffb540,1);
    ...
    *(s32 *)(temp_19 + 0x1C68) = temp_2;
    ...
    func_0025ea20(-78.0f, -82.0f, 0.0f, 0x4972FF, 0xFF, 0xB1,
                  uGpffffb540, 1, 0x5B, 0x5B,
                  (f32)(*(s32 *)(temp_19 + 0x1C68) * -0x168) / 1440.0f,
                  1.0f, 1.0f);
    func_0025ea20(540.0f, 347.0f, 0.0f, 0x4972FF, 0xFF, 0xB1,
                  uGpffffb540, 1, 0x5B, 0x15B,
                  (f32)(*(s32 *)(temp_19 + 0x1C68) * -0x168) / 1440.0f,
                  1.0f, 1.0f);
    func_0025e9e0(0.0f,0.0f,0.0f,0xFFFFFF,0xFF,0xAF,uGpffffb540,1);
    func_0025e9e0(0.0f,346.0f,0.0f,0xFFFFFF,0xFF,0xAE,uGpffffb540,1);
    ...
    func_0025e9e0(sp98,sp9c,0.0f,0xFFFFFF,var_20,0x13,uGpffffb540,1);
    temp_f20 = 105.0f + sp98;
    func_0025e9e0(temp_f20,sp9c,0.0f,0xFFFFFF,var_20,0x11,uGpffffb540,1);
    temp_f21 = sp9c + 3.0f;
    func_0025e9e0(sp98,temp_f21,0.0f,0xFFFFFF,var_18,0x13,uGpffffb540,1);
    func_0025e9e0(temp_f20,temp_f21,0.0f,0xFFFFFF,var_18,0x12,uGpffffb540,1);
    func_002a02f0(arg0, 0);
    if (*(s32 *)(temp_19 + 0x1C34) != 0) {
        var_16 = 0xFF;
    }
    temp_18 = *(u8 **)(arg0 + 0x38);
    func_0025e9e0(229.0f,150.0f,0.0f,0x4972FF,var_16,0x17,uGpffffb540,1);
    func_0025e9e0(229.0f,182.0f,0.0f,0x4972FF,var_16,0x17,uGpffffb540,1);
    if (*(s32 *)(temp_18 + 0x14) != 3) {
        ...
        func_0025e9e0((f32)var_3_2,(f32)var_2,0.0f,0xCCFF33,var_16,0x18,uGpffffb540,1);
    }
    ...
    while (var_16_2 < 0x18) {
        ...
        func_0025e9e0(temp_f21_2,temp_f20_2,0.0f,0x4972FF,0xFF,1,uGpffffb540,1);
        if (var_16_2 == 0) {
            func_0025e9e0(18.0f,219.0f,0.0f,0x4972FF,0xFF,0x1B,uGpffffb540,1);
        }
        if (var_16_2 == 5) {
            func_0025e9e0(18.0f,366.0f,0.0f,0x4972FF,0xFF,0x1C,uGpffffb540,1);
        }
        if (var_16_2 == 0x12) {
            func_0025e9e0((f32)0x24A,219.0f,0.0f,0x4972FF,0xFF,0x1D,uGpffffb540,1);
        }
        if (var_16_2 == 0x17) {
            func_0025e9e0((f32)0x24A,366.0f,0.0f,0x4972FF,0xFF,0x1E,uGpffffb540,1);
        }
        if (*(s32 *)(temp_19 + 0x14) != 3) {
            ...
            if (var_16_2 == temp_18_2) {
                func_0025e9e0(temp_f21_2,temp_f20_2,0.0f,0x49AFFD,0xFF,1,uGpffffb540,1);
                if (var_16_2 == 0) {
                    func_0025e9e0(18.0f,sp9c,0.0f,0x49AFFD,0xFF,0x1B,uGpffffb540,1);
                }
                if (var_16_2 == 5) {
                    func_0025e9e0(18.0f,(171.0f + sp9c) - 24.0f,0.0f,0x49AFFD,0xFF,0x1C,uGpffffb540,1);
                }
                if (var_16_2 == 0x12) {
                    func_0025e9e0((f32)0x24A,sp9c,0.0f,0x49AFFD,0xFF,0x1D,uGpffffb540,1);
                }
                if (var_16_2 == 0x17) {
                    func_0025e9e0((f32)0x24A,(171.0f + sp9c) - 24.0f,0.0f,0x49AFFD,0xFF,0x1E,uGpffffb540,1);
                }
                ...
                func_0025e9e0(temp_f21_2,temp_f20_2,0.0f,0x49AFFD,temp_20_3,1,uGpffffb540,1);
                if (var_16_2 == 0) {
                    func_0025e9e0(18.0f,sp9c,0.0f,0x49AFFD,temp_20_3,0x1B,uGpffffb540,1);
                }
                if (var_16_2 == 5) {
                    func_0025e9e0(18.0f,(171.0f + sp9c) - 24.0f,0.0f,0x49AFFD,temp_20_3,0x1C,uGpffffb540,1);
                }
                if (var_16_2 == 0x12) {
                    func_0025e9e0((f32)0x24A,sp9c,0.0f,0x49AFFD,temp_20_3,0x1D,uGpffffb540,1);
                }
                if (var_16_2 == 0x17) {
                    func_0025e9e0((f32)0x24A,(171.0f + sp9c) - 24.0f,0.0f,0x49AFFD,temp_20_3,0x1E,uGpffffb540,1);
                }
            }
        }
        var_16_2 += 1;
    ...
    if (*(s32 *)(temp_19 + 0x14) != 3) {
        ...
        func_0025e9e0(var_f2 - 12.0f,(f32)((*(s32 *)(temp_19 + 0x20) * 0x19) + 0xE5) - 12.0f,0.0f,0xCCFF33,0xFF,0xF,uGpffffb540,1);
    }
    var_20_2 = 0;
    while (var_20_2 < 6) {
        var_18_2 = 0;
        while (var_18_2 < 0x14) {
            ...
            if (temp_2_2 >= 0) {
                ...
                func_0025e9e0(var_f12,(f32)((var_20_2 * 0x19) + 0xE5),0.0f,0x2D2D2D,0xFF,temp_2_2 + 0x20,uGpffffb540,1);
            }
            var_18_2 += 1;
        }
        var_20_2 += 1;
    ...
    if ((*(s32 *)(temp_19 + 0x14) == 3) &&
        (*(s32 *)(temp_19 + 8) == 0)) {
        func_0025e9e0(0.0f,102.0f,0.0f,0xFFFFFF,0xFF,0xAC,uGpffffb540,1);
    }
...
void func_002a12e0(u8 *arg0, s32 arg1) {
    ...
    s32 var_3_2;
    temp_arg0 = arg0;
    temp_16 = *(u8 **)(temp_arg0 + 0x38);
    if ((arg1 >= 0) && (func_002a2ca0(temp_16 + 0x178) == 0)) {
        temp_f1 = 255.0f * func_002a2cd0(temp_16 + 0x178);
        if (!(temp_f1 >= 2.1474836e9f)) {
            var_3 = 0x4F000000 & 0xFF;
        } else {
            var_3 = ((s32)(temp_f1 - 2.1474836e9f) | 0x80000000) & 0xFF;
        ...
        temp_17 = var_3 & 0xFF;
        func_0025e9e0(0.0f,0.0f,0.0f,0xFFFFFF,temp_17,0xA4,uGpffffb540,1);
        temp_2 = *(s32 *)(temp_16 + 0x1C68) + 1;
        *(s32 *)(temp_16 + 0x1C68) = temp_2;
        if (temp_2 >= 0x5A1) {
            *(s32 *)(temp_16 + 0x1C68) = 0;
        }
        func_0025ea20(-78.0f, -82.0f, 0.0f, 0x4972FF, temp_17, 0xB1,
                      uGpffffb540, 1, 0x5B, 0x5B,
                      (f32)(*(s32 *)(temp_16 + 0x1C68) * -0x168) / 1440.0f,
                      1.0f, 1.0f);
        func_0025ea20(540.0f, 347.0f, 0.0f, 0x4972FF, temp_17, 0xB1,
                      uGpffffb540, 1, 0x5B, 0x15B,
                      (f32)(*(s32 *)(temp_16 + 0x1C68) * -0x168) / 1440.0f,
                      1.0f, 1.0f);
        func_0025e9e0(0.0f,0.0f,0.0f,0xFFFFFF,0xFF,0xAF,uGpffffb540,1);
    ...
    if (arg1 >= 2) {
        var_18 = 0;
        while (var_18 < 0x18) {
            temp_17_2 = temp_16 + (var_18 * 0x98) + 0x340;
            if (func_002a2ca0(temp_17_2) == 0) {
                temp_f1_2 = 255.0f * func_002a2cd0(temp_17_2);
                if (!(temp_f1_2 >= 2.1474836e9f)) {
                ...
                func_0025e9e0((f32)(((var_18 / 6) * 0x94) + 0x19),(f32)(((var_18 % 6) * 0x19) + 0xE3),0.0f,0x4972FF,temp_17_3,1,uGpffffb540,1);
                if (var_18 == 0) {
                    func_0025e9e0(18.0f,sp9c,0.0f,0x4972FF,temp_17_3,0x1B,uGpffffb540,1);
                }
                if (var_18 == 5) {
                    func_0025e9e0(18.0f,(171.0f + sp9c) - 24.0f,0.0f,0x4972FF,temp_17_3,0x1C,uGpffffb540,1);
                }
                if (var_18 == 0x12) {
                    func_0025e9e0((f32)0x24A,sp9c,0.0f,0x4972FF,temp_17_3,0x1D,uGpffffb540,1);
                }
                if (var_18 == 0x17) {
                    func_0025e9e0((f32)0x24A,(171.0f + sp9c) - 24.0f,0.0f,0x4972FF,temp_17_3,0x1E,uGpffffb540,1);
                }
            }
            var_18 += 1;
        }
    ...
    if (arg1 >= 2) {
        var_20 = 0;
        while (var_20 < 6) {
            temp_18 = temp_16 + (var_20 * 0x98);
            if (func_002a2ca0(temp_18 + 0x1180) == 0) {
                var_17 = 0;
                while (var_17 < 0x14) {
                    temp_3 = *(s16 *)(D_007485D0 + (var_20 * 0x28) + (var_17 * 2));
                    if (temp_3 >= 0) {
                        ...
                        func_0025e9e0(var_f21,(f32)((var_20 * 0x19) + 0xE5) + sp9c,0.0f,0x2D2D2D,0xFF,temp_3 + 0x20,uGpffffb540,1);
                    }
                    var_17 += 1;
                }
            }
...
void func_002aa450(void) {
    ...
    work.pair0.bits = *(s64 *)D_0063EDF0;
    work.pair0.value = *(f32 *)D_0063EDF8;
    work.pair1.bits = *(s64 *)D_0063EE00;
    work.pair1.value = *(f32 *)D_0063EE08;
    work.pair2.bits = *(s64 *)D_0063EE10;
    work.pair2.value = *(f32 *)D_0063EE18;
    work.pair3.bits = *(s64 *)D_0063EE20;
    work.pair3.value = *(f32 *)D_0063EE28;
    work.pair4.bits = *(s64 *)D_0063EE30;
    work.pair4.value = *(f32 *)D_0063EE38;
    ratio = (f32)(*(s32 *)0x00882F2C) / 5.0f;
    temp = *(s32 *)0x00882F28 + 1;
    *(s32 *)0x00882F28 = temp;
    if (temp >= 0x3C) {
        state[2] = 0;
    }
    phase = (f32)state[2] / 60.0f;
    offset = -80.0f - (1.0f - ratio) * 10.0f;
    func_003e0870(work.matrix, &work.pair0, 0, offset);
    func_003e4320(&work.pair3, &work.pair3, work.matrix);
    angle = 360.0f * phase;
    func_003e0870(work.matrix, &work.pair3, 2, angle);
    ...
    func_003e0870(work.matrix, &work.pair0, 0, offset);
    func_003e0870(work.matrix, &work.pair3, 2, 120.0f + angle);
    func_003e0a90(work.matrix, &work.pair4, 2);
    func_00366960((s32)color_y, (s32)color_x, 0x18, 0x1F, 0xFFFF00, 0xFF, 1, 0,
                  0.0f, 0, (s32 *)&work.matrix, 0);
    func_003e0870(work.matrix, &work.pair0, 0, offset);
    func_003e0870(work.matrix, &work.pair3, 2, 240.0f + angle);
    func_003e0a90(work.matrix, &work.pair4, 2);
    func_00366960((s32)color_y, (s32)color_x, 0x18, 0x1F, 0xFF0000, 0xFF, 1, 0,
                  0.0f, 0, (s32 *)&work.matrix, 0);
    func_003e0870(work.matrix, &work.pair1, 0, fGpffff855c);
    func_003e0870(work.matrix, &work.pair2, 2, 357.0f * phase + 3.0f);
    work.pair4.value *= ratio;
