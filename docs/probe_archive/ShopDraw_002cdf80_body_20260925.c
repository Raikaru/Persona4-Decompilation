/* func_002cdf80 (shop buy list: draw + input) best draft, 2026-09-25.
   fnalign: retail 3458 vs object 3456 instrs, 140 edits (+84 reloc-only), measured with
   `python3 tools/fnalign.py src/Event/Fcl/y_fclShopDraw.c func_002cdf80 --candidate <this file> --quiet`.
   Needs `s32 func_002e2700(void *)` (committed with this note). See ShopDraw_002cdf80_20260925.md. */
typedef struct {
    s16 f0;
    s16 f2;
    s16 f4;
        ...
        for (cur = start, row = 0; cur < start + n; cur++, row++) {
            if (cur < func_002e26f0(work->list[work->sel])) {
                ...
                if (work->sel == 0 && cur == 0) {
                    if (func_002e26f0(work->list[work->sel]) > 1) {
                        {
                            ...
                            for (i2 = 0; i2 < 3; i2++) {
                                sp1B0 = func_002b2970((f32)((i2 << 5) + 0x6F), 143.0f);
                                func_002e0b20(0x3C, sp1B0, 115.0f, lineColor, 0xFF, 0, D_00795E60);
                                sp1A8 = func_002b2970((f32)((i2 << 5) + 0x1A1), 143.0f);
                                func_002e0b20(0x3C, sp1A8, 115.0f, lineColor, 0xFF, 0, D_00795E60);
                            }
                        }
                    ...
                    sp1A0 = func_002b2970(53.0f + sp1D0.x, 7.0f + sp1D0.y);
                    pos = *(Vec2f *)&sp1A0;
                    func_00275680(pos.x, pos.y, 115.0f, textColor, 0, 1, func_001067f0((s16)func_002e2830(work->list[work->sel], cur)), 0, 0, D_00795E30, -1);
                    digits = func_00106a90((s16)func_002e2830(work->list[work->sel], cur)) / 5;
                    sp198 = func_002b2970(372.0f + sp1D0.x, 16.0f + sp1D0.y);
                    func_002cacd0(sp198, 115.0f, rowColor, 0x10, 5, digits, 9, 0x7B, (s32)func_0046a770(D_0063FB50), (s32)work->font, 0xA9);
                    sp190 = func_002b2970(400.0f + sp1D0.x, 18.0f + sp1D0.y);
                    func_002e0b20(0x47, sp190, 115.0f, iconColor, 0xFF, 0, D_00795E60);
                    sp188 = func_002b2970((f32)0x1AF + sp1D0.x, 16.0f + sp1D0.y);
                    func_002cacd0(sp188, 115.0f, rowColor, 0x10, 5, func_00106600((s16)func_002e2830(work->list[work->sel], cur)) & 0xFF, 9, 0x7B,
        ...
        if ((D_008C0276[0] & 0x1000) && work->busy == 0) {
            ...
            if (func_002e26f0(work->list[work->sel]) > D_00748908[work->sel] && arg1 != 1) {
                ...
                if ((work->sel != 0 || work->cursor != 0) && func_002e26f0(work->list[work->sel]) > 0) {
                    ...
                    work->fF42[2] = ((u8 *)func_002e04e0(work->O(0xDD0)))[0x7B];
                    work->fF3C = 0;
                    func_002e0700(work->O(0xEC4), 3, 1.0f, iGpffff8504, 6, 0, 0);
                    func_002e0700(work->O(0xEC8), 4, 1.0f, iGpffff8504, 6, 0, 0);
                    func_002e0700(work->O(0xE38), 0x80, 1.0f, iGpffff8504, 6, 0, 0);
                    func_002e0700(work->O(0xEB4), 3, 1.0f, iGpffff8504, 6, 1, 0);
                    func_002e0700(work->O(0xEB8), 4, 1.0f, iGpffff8504, 6, 1, 0);
                    func_002e0700(work->O(0xCC4), 0x23, 1.0f, iGpffff8504, 6, 1, 0);
                    func_002e0700(work->O(0xEBC), 3, 1.0f, iGpffff8504, 6, 2, 0);
                    func_002e0700(work->O(0xEC0), 4, 1.0f, iGpffff8504, 6, 2, 0);
                    func_002e0700(work->O(0xCC0), 0x22, 1.0f, iGpffff8504, 6, 1, 0);
            ...
            if (arg1 != 1) {
                ...
                b = (Vec2f *)D_0063F5B8;
                sp180 = func_002b2970(b->x, b->y);
                sp178 = func_002b2970(b->x, 300.0f + b->y);
                func_002e0620(work->O(0xC64), *(u64 *)&sp180, *(u64 *)&sp178, 0, 0xA, 0);
                ...
                func_002e0660(work->O(0xD80), 0xFF, 0, 0, 0xA, 0);
                {
                    ...
                    for (i3 = 0x43; i3 < 0x49; i3++) {
                        sp170 = func_002b2970(((ShopWork *)func_002e04e0(work->obj[i3]))->field_2C, ((ShopWork *)func_002e04e0(work->obj[i3]))->field_30);
                        sp168 = func_002b2970(((ShopWork *)func_002e04e0(work->obj[i3]))->field_2C, 170.0f + ((ShopWork *)func_002e04e0(work->obj[i3]))->field_30);
                        func_002e0620(work->obj[i3], *(u64 *)&sp170, *(u64 *)&sp168, 1, 5, 0);
                    }
                }
                ...
                func_002e0660(work->O(0xC90), 0xFF, 0, 0, 6, 0);
                {
                    ...
                    for (i4 = 0; i4 < 3; i4++) {
                        func_002e04f0(work->obj[i4 + 0x82], 0, 1);
                    }
                }
                func_002e04f0(work->O(0xDCC), 0, 1);
                func_002e04f0(work->O(0xDD0), 0, 1);
                e = func_002e04e0(work->O(0xEC4));
                sp160 = func_002b2970(((ShopWork *)func_002e04e0(work->O(0xEC4)))->field_2C, 500.0f + ((ShopWork *)func_002e04e0(work->O(0xEC4)))->field_30);
                func_002e0620(work->O(0xEC4), *(u64 *)(e + 0x2C), *(u64 *)&sp160, 2, 0xF, 0);
                e = func_002e04e0(work->O(0xEC8));
                sp158 = func_002b2970(((ShopWork *)func_002e04e0(work->O(0xEC8)))->field_2C, 500.0f + ((ShopWork *)func_002e04e0(work->O(0xEC8)))->field_30);
                func_002e0620(work->O(0xEC8), *(u64 *)(e + 0x2C), *(u64 *)&sp158, 2, 0xF, 0);
                e = func_002e04e0(work->O(0xE38));
                sp150 = func_002b2970(((ShopWork *)func_002e04e0(work->O(0xE38)))->field_2C, 500.0f + ((ShopWork *)func_002e04e0(work->O(0xE38)))->field_30);
                func_002e0620(work->O(0xE38), *(u64 *)(e + 0x2C), *(u64 *)&sp150, 2, 0xF, 0);
                e = func_002e04e0(work->O(0xEB4));
                sp148 = func_002b2970(((ShopWork *)func_002e04e0(work->O(0xEB4)))->field_2C, 500.0f + ((ShopWork *)func_002e04e0(work->O(0xEB4)))->field_30);
                func_002e0620(work->O(0xEB4), *(u64 *)(e + 0x2C), *(u64 *)&sp148, 2, 0xF, 1);
                e = func_002e04e0(work->O(0xEB8));
                sp140 = func_002b2970(((ShopWork *)func_002e04e0(work->O(0xEB8)))->field_2C, 500.0f + ((ShopWork *)func_002e04e0(work->O(0xEB8)))->field_30);
                func_002e0620(work->O(0xEB8), *(u64 *)(e + 0x2C), *(u64 *)&sp140, 2, 0xF, 1);
                e = func_002e04e0(work->O(0xCC4));
                sp138 = func_002b2970(((ShopWork *)func_002e04e0(work->O(0xCC4)))->field_2C, 500.0f + ((ShopWork *)func_002e04e0(work->O(0xCC4)))->field_30);
                func_002e0620(work->O(0xCC4), *(u64 *)(e + 0x2C), *(u64 *)&sp138, 2, 0xF, 1);
                e = func_002e04e0(work->O(0xEBC));
                sp130 = func_002b2970(((ShopWork *)func_002e04e0(work->O(0xEBC)))->field_2C, 500.0f + ((ShopWork *)func_002e04e0(work->O(0xEBC)))->field_30);
                func_002e0620(work->O(0xEBC), *(u64 *)(e + 0x2C), *(u64 *)&sp130, 2, 0xF, 2);
                e = func_002e04e0(work->O(0xEC0));
                sp128 = func_002b2970(((ShopWork *)func_002e04e0(work->O(0xEC0)))->field_2C, 500.0f + ((ShopWork *)func_002e04e0(work->O(0xEC0)))->field_30);
                func_002e0620(work->O(0xEC0), *(u64 *)(e + 0x2C), *(u64 *)&sp128, 2, 0xF, 2);
                e = func_002e04e0(work->O(0xCC0));
                sp120 = func_002b2970(((ShopWork *)func_002e04e0(work->O(0xCC0)))->field_2C, 500.0f + ((ShopWork *)func_002e04e0(work->O(0xCC0)))->field_30);
                func_002e0620(work->O(0xCC0), *(u64 *)(e + 0x2C), *(u64 *)&sp120, 2, 0xF, 2);
                {
                    s16 i5;
                ...
                }
                {
                    ...
                    for (i7 = 0; i7 < 7; i7++) {
                        b = (Vec2f *)D_0063F560 + (i7 + 0x3A);
                        func_002e09e0(work->obj[i7 + 0x3A], 0x56, (f32)(i7 + 0x64));
                        if (i7 > 0) {
                            c1EC = func_002b2a60(0xED, 0x80, 0, 0xFF);
                            t = (u8 *)func_002e04e0(work->obj[i7 + 0x3A]);
                            *(FclDrawColor *)(t + 0x79) = c1EC;
                        }
                        sp118 = func_002b2970(80.0f + b->x, b->y);
                        sp110 = func_002b2970(b->x, b->y);
                        func_002e0620(work->obj[i7 + 0x3A], *(u64 *)&sp118, *(u64 *)&sp110, 0, 3, i7);
                        func_002e0660(work->obj[i7 + 0x3A], 0, 0xFF, 0, 3, i7);
                    }
                }
                ...
                *(FclDrawColor *)(t + 0x79) = c1E8;
                ...
                sp108 = func_002b2970((f32)0x103, 404.0f);
                sp100 = func_002b2970((f32)0x103, 404.0f);
                func_002e0620(work->O(0xDF0), *(u64 *)&sp108, *(u64 *)&sp100, 0, 0, 0);
                func_002e09e0(work->O(0xDE4), 0x41, 47.0f);
                func_002e0660(work->O(0xDE4), 0xFF, 0, 0, 0xA, 0);
                spF8 = func_002b2970(338.0f, 404.0f);
                spF0 = func_002b2970(338.0f, 404.0f);
                func_002e0620(work->O(0xDE4), *(u64 *)&spF8, *(u64 *)&spF0, 0, 0, 0);
                ((ShopWork *)func_002e04e0(work->O(0xDE8)))->field_2C = 198.0f;
                ((ShopWork *)func_002e04e0(work->O(0xDE8)))->field_30 = (f32)0x151;
                func_002e09e0(work->O(0xC4C), 0x40, 191.0f);
                {
                    r = func_0046d200(work->font, 5);
                    *(s16 *)((u8 *)func_002e04e0(work->O(0xC4C)) + 0x100) = func_0046b260(r);
                    *(s16 *)((u8 *)func_002e04e0(work->O(0xC4C)) + 0x102) = func_0046b2f0(r);
                    func_0046d280(r);
                }
                func_002e0660(work->O(0xC4C), 0, 0xCC, 0, 4, 4);
                func_002e0940(work->O(0xC4C), 0.0f, fGpffff8520, 0, 4, 4);
                spE8 = func_002b2970(-240.0f, 400.0f);
                spE0 = func_002b2970(-240.0f, 310.0f);
                func_002e0620(work->O(0xC4C), *(u64 *)&spE8, *(u64 *)&spE0, 0, 4, 4);
                ...
                {
                    r = func_0046d200(work->font, 6);
                    *(s16 *)((u8 *)func_002e04e0(work->O(0xC50)) + 0x100) = func_0046b260(r);
                ...
                {
                    r = func_0046d200(work->font, 6);
                    *(s16 *)((u8 *)func_002e04e0(work->O(0xE7C)) + 0x100) = func_0046b260(r);
