// FUN_00164FA0 archive (wave Po lane PoA, killed by provider rate limit at 9 minutes; live state at cutoff, MISMATCH nd148 712/720).
/* measured: opt_common_subs off preserves the retail per-call 0x750 base
   recomputation; the M2C variable order and copy loop hold the base and copy
   shape. */
...
void func_00164fa0(s32 arg0)
{
    ...
    if (*temp_21 != 0) {
        ...
        *(u8 **)(*temp_20_2 + 0x228) = (u8 *)func_00478750(iGpffffb274);
        ...
        if (arg0 != 0) {
            temp_2_2 = func_0017e890(0, temp_18, D_007EF9B0 + ((arg0 - 1) * 0x750));
