...
// FUN_003561D0
void func_003561d0(s64 arg0, s32 arg1, s32 arg2, f32 f0, f32 f1)
{
    s64 saved0[1];
    s32 saved1;
    s32 var8;
    ...
    func_00365f00(*(s64 *)((u8 *)saved0), saved1, saved1, 4, var8, 0.0f, f0 / iGpffff83d4, iGpffff8544 + f1, 1.0f, 1.0f);
}
// FUN_00356820
