/* object 428B; retail window 432B; normalized_diff 13; differing words 0x10, 0x14, 0x132, 0x13A, 0x155, 0x15A, 0x15E; exact cast applied at unsigned byte-to-float abs site: (f32)(u32)a; signed halfword ratio remains (f32)raw; residual is prologue load order, relocation-owned GPREL, output register coloring; ruled out hand-written conversion, guard polarity, local reuse, masks, compound assignment, and pragma wrappers. */
