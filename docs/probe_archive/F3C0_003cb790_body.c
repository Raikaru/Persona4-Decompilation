/* func_003cb790 archive: object 56B, window 48B, normalized_diff 29; differing offsets 24-29 and 31-40; wrapper takes three parameters (second ignored), helper prototype is block-scope s32 func_003ce560(s32,u8*), and schedule fills the call delay slot; object exceeds window, so archive immediately; residual is the retail movz $s0,$zero,$v0 conditional-move shape and resulting epilogue size, not a declaration or global-address issue. */
