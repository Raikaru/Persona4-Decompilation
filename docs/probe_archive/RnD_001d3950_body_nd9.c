// object_size 500, window 512, normalized_diff 9, differing offsets 112 120 160 168 172 180; instruction deficit 3; classification aggregate default-copy z-width plus table-load FPU order; ruled out movz/movn, COP1 accumulator, standalone MMI, framed tail-jump, sd-vs-sq callee-save floors
