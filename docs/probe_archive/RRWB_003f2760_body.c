/* object_size=208 window=208 normalized_diff=28 differing_offsets=26,30,34,35,54,55,58,70,74,82,86,89,90,94,98,99 classification=exact-size saved-register-colouring/table-load residual; ruled_out=movz/movn,COP1-accumulator-MAC,standalone-MMI-H009,framed-tail-jump,sd-saved-register-floor,COP2/VU0,return-tail-shape,array-table-global,splitting-index-local; prologue=frame 0x50, saved $s3/$s2/$s1/$s0 four locals, no incoming args; declarations corrected at block scope: iGpffffb810/iGpffffb80c/iGpffffabd4 u16 GP scalars, iGpffffb808 u8* GP scalar table base, func_003f34e0(void*,u32); measured no_branch_likely on/off; no object-size deficit */
