/* Best final candidate for func_00143cf0 before required revert.
 * Measured object 708B/window 672B; 84 differing words.
 * Retail register list derived: s3=arg0 then loop index, s2=arg1,
 * s7=arg2, s5=arg3, fp=arg4, s1=arg6 then var17, s6=arg6>>4,
 * s0=arg7>>4, s4=packet cursor; stack arg5 is spAC. The a11>>4 stride
 * operand remains an inline caller temporary in this best candidate. */
...
loop_8:
    if (var_19 < temp_22) {
        ...
        var_20 += 0x60;
        var_17 = var_17 + (arg3 * temp_16) + (arg3 * (arg_sp10 >> 4));
        var_19 += 1;
        goto loop_8;
    }
