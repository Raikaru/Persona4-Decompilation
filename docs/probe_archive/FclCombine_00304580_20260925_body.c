 ...
 * FclCombine_00304580_20260925.md). Object 4595 vs retail 4560 instrs;
 * per-case aligned edits 706 (previous archive 796). */
typedef struct {
    s8 f0;
    u8 f1;
    u8 pad2[0xB];
