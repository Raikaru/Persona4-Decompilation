...
loop_00485630_body:
    ...
    if ((*(s32 *)(var_17 + 0x68) & 0x60) != 0) {
        ...
        temp_4 = *(u8 **)(var_17 + 0x90);
        temp_2_2 = (void (*)(s32, void *))(D_00713480 + (*(u16 *)(temp_4 + 4) << 6) + 0x24);
        if (temp_2_2 != NULL) {
            temp_2_2(*(s32 *)(temp_4 + 8), &sp60);
        }
    }
    temp_2_3 = *(u8 **)(var_17 + 0x90);
    ((void (*)(s32))(D_00713480 + (*(u16 *)(temp_2_3 + 4) << 6) + 0x8))(*(s32 *)(temp_2_3 + 8));
next_00485630:
