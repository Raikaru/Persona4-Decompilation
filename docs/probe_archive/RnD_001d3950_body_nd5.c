// object_size 500, window 512, normalized_diff 5, differing offsets 112 120; instruction deficit 3; classification aggregate default-copy z-width; table aggregate copy exact; ruled out movz/movn, COP1 accumulator, standalone MMI, framed tail-jump, sd-vs-sq callee-save floors
