...
| Byte-identical functions | 7,463 (56.961% of windows) |
...
| First-party matched, scored for recovery | 6,749 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.297%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,169 (32.138%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,751 (70.396%) |
| — still carrying decompiler local names | 1,979 (29.323%) |
