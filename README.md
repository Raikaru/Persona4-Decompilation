...
| Byte-identical functions | 7,763 (59.25% of windows) |
...
| — TYPED (no raw-offset or `M2C_` access) | 2,173 (31.97%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,790 (70.472%) |
| — still carrying decompiler local names | 1,986 (29.219%) |
