...
| Byte-identical functions | 6,598 (50.363% of windows) |
| Under test (a `// FUN_` marker scores them) | 13,101 (100.0% of windows) |
| Not yet under test, supplied as retail bytes | 0 (0.0% of windows) |
| In byte-exact linked C objects | 1,400 (10.686% of windows), with 475 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 5,980 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.592%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,127 (35.569%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,051 (67.742%) |
| — still carrying decompiler local names | 1,552 (25.953%) |
