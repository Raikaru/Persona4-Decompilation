...
| Byte-identical functions | 7,905 (60.334% of windows) |
...
| In byte-exact linked C objects | 1,597 (12.189% of windows), with 212 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,275 C-matched (91.472%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,275 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.454%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,786 (28.462%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,302 (68.558%) |
| — still carrying decompiler local names | 1,924 (30.661%) |
