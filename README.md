...
| Byte-identical functions | 7,464 (56.968% of windows) |
...
| — NAMED (not a `func_<address>` placeholder) | 155 (2.296%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,169 (32.133%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,752 (70.4%) |
| — still carrying decompiler local names | 1,979 (29.319%) |
