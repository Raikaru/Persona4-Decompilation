...
| Byte-identical functions | 7,509 (57.312% of windows) |
...
| — NAMED (not a `func_<address>` placeholder) | 155 (2.281%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,181 (32.097%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,797 (70.596%) |
| — still carrying decompiler local names | 1,988 (29.257%) |
