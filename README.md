...
| Byte-identical functions | 7,778 (59.365% of windows) |
...
| First-party matched, scored for recovery | 6,812 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.261%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.885%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,802 (70.493%) |
| — still carrying decompiler local names | 1,986 (29.154%) |
