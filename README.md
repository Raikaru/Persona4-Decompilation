...
| Byte-identical functions | 7,750 (59.151% of windows) |
...
| First-party matched, scored for recovery | 6,784 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.27%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,164 (31.899%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,782 (70.489%) |
| — still carrying decompiler local names | 1,987 (29.29%) |
