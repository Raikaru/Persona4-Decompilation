...
| — TYPED (no raw-offset or `M2C_` access) | 1,249 (37.917%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,987 (60.322%) |
| — still carrying decompiler local names | 792 (24.044%) |
