...
| Byte-identical functions | 4,111 (31.415% of windows) |
...
| First-party matched, scored for recovery | 3,493 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.437%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,350 (38.649%) |
| — DOCUMENTED (prose, or trivially self-evident) | 2,186 (62.582%) |
| — still carrying decompiler local names | 794 (22.731%) |
