...
| Byte-identical functions | 7,757 (59.205% of windows) |
...
| First-party matched, scored for recovery | 6,791 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.268%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,166 (31.895%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,788 (70.505%) |
| — still carrying decompiler local names | 1,987 (29.259%) |
