...
| Byte-identical functions | 3,877 (29.632% of windows) |
| In byte-exact linked C objects | 1,211 (9.256% of windows), with 532 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,260 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.755%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,242 (38.098%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,962 (60.184%) |
| — still carrying decompiler local names | 786 (24.11%) |
