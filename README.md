...
| Byte-identical functions | 7,904 (60.327% of windows) |
...
| In byte-exact linked C objects | 1,596 (12.181% of windows), with 213 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,274 C-matched (91.458%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,274 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.455%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,786 (28.467%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,301 (68.553%) |
| — still carrying decompiler local names | 1,924 (30.666%) |
