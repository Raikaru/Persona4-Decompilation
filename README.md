...
| Byte-identical functions | 3,916 (29.925% of windows) |
| Under test (a `// FUN_` marker scores them) | 4,876 (37.261% of windows) |
| Not yet under test, supplied as retail bytes | 8,210 (62.739% of windows) |
| In byte-exact linked C objects | 1,235 (9.438% of windows), with 508 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,298 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.7%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,251 (37.932%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,991 (60.37%) |
| — still carrying decompiler local names | 792 (24.015%) |
