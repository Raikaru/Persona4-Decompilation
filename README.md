...
| Byte-identical functions | 7,733 (59.022% of windows) |
...
| In byte-exact linked C objects | 1,561 (11.914% of windows), with 247 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,767 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.276%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,158 (31.89%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,769 (70.474%) |
| — still carrying decompiler local names | 1,986 (29.348%) |
