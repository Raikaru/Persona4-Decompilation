...
| Byte-identical functions | 7,783 (59.403% of windows) |
...
| First-party matched, scored for recovery | 6,817 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.259%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.862%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,805 (70.486%) |
| — still carrying decompiler local names | 1,986 (29.133%) |
