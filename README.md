...
| Byte-identical functions | 7,920 (60.449% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,290 C-matched (91.691%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,290 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.448%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,787 (28.41%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,311 (68.537%) |
| — still carrying decompiler local names | 1,924 (30.588%) |
