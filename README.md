...
| Byte-identical functions | 7,812 (59.624% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,182 C-matched (90.117%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,182 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.491%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,771 (28.648%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,202 (67.972%) |
| — still carrying decompiler local names | 1,910 (30.896%) |
