...
| Byte-identical functions | 7,786 (59.426% of windows) |
...
| First-party matched, scored for recovery | 6,820 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.258%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.848%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,810 (70.528%) |
| — still carrying decompiler local names | 1,986 (29.12%) |
