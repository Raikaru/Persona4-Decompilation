...
| Byte-identical functions | 7,717 (58.899% of windows) |
...
| First-party matched, scored for recovery | 6,751 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.281%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,154 (31.906%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,750 (70.36%) |
| — still carrying decompiler local names | 1,985 (29.403%) |
