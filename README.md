...
| Byte-identical functions | 7,776 (59.35% of windows) |
...
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.894%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,802 (70.514%) |
| — still carrying decompiler local names | 1,986 (29.163%) |
