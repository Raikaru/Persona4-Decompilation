...
| Byte-identical functions | 7,781 (59.388% of windows) |
...
| First-party matched, scored for recovery | 6,815 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.26%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.871%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,804 (70.492%) |
| — still carrying decompiler local names | 1,986 (29.142%) |
