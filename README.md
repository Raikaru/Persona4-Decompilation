...
| Byte-identical functions | 7,902 (60.311% of windows) |
...
| In byte-exact linked C objects | 1,595 (12.174% of windows), with 214 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,272 C-matched (91.429%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,272 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.455%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,784 (28.444%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,300 (68.559%) |
| — still carrying decompiler local names | 1,924 (30.676%) |
