...
| Byte-identical functions | 3,954 (30.215% of windows) |
| Under test (a `// FUN_` marker scores them) | 4,914 (37.552% of windows) |
| Not yet under test, supplied as retail bytes | 8,172 (62.448% of windows) |
| In byte-exact linked C objects | 1,235 (9.438% of windows), with 508 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,336 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.646%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,289 (38.639%) |
| — DOCUMENTED (prose, or trivially self-evident) | 2,028 (60.791%) |
| — still carrying decompiler local names | 792 (23.741%) |
