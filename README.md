...
| Byte-identical functions | 3,890 (29.726% of windows) |
| In byte-exact linked C objects | 1,222 (9.338% of windows), with 521 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,272 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.737%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,243 (37.989%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,971 (60.238%) |
| — still carrying decompiler local names | 787 (24.053%) |
