...
| Byte-identical functions | 7,711 (58.854% of windows) |
...
| First-party matched, scored for recovery | 6,745 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.283%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,150 (31.875%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,747 (70.378%) |
| — still carrying decompiler local names | 1,985 (29.429%) |
