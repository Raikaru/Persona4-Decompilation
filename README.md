...
| Byte-identical functions | 7,756 (59.197% of windows) |
...
| First-party matched, scored for recovery | 6,790 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.268%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,166 (31.9%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,787 (70.501%) |
| — still carrying decompiler local names | 1,987 (29.264%) |
