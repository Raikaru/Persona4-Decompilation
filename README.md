...
| Byte-identical functions | 3,898 (29.788% of windows) |
| In byte-exact linked C objects | 1,229 (9.392% of windows), with 514 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,280 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.726%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,246 (37.988%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,977 (60.274%) |
| — still carrying decompiler local names | 787 (23.994%) |
