...
| Byte-identical functions | 7,712 (58.861% of windows) |
...
| — NAMED (not a `func_<address>` placeholder) | 154 (2.283%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,151 (31.886%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,748 (70.382%) |
| — still carrying decompiler local names | 1,985 (29.425%) |
