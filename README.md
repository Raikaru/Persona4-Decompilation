...
| Byte-identical functions | 7,785 (59.418% of windows) |
...
| First-party matched, scored for recovery | 6,819 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.258%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.852%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,809 (70.524%) |
| — still carrying decompiler local names | 1,986 (29.125%) |
