...
| Byte-identical functions | 4,244 (32.439% of windows) |
...
| In byte-exact linked C objects | 1,249 (9.547% of windows), with 499 assembly fallbacks still inside those objects |
