...
| Byte-identical functions | 6,626 (50.576% of windows) |
...
| First-party matched, scored for recovery | 6,008 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.58%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,127 (35.403%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,073 (67.793%) |
| — still carrying decompiler local names | 1,569 (26.115%) |
