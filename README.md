...
| Byte-identical functions | 7,755 (59.189% of windows) |
...
| First-party matched, scored for recovery | 6,789 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.268%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,166 (31.905%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,786 (70.496%) |
| — still carrying decompiler local names | 1,987 (29.268%) |
