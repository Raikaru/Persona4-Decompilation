...
| Byte-identical functions | 7,741 (59.083% of windows) |
...
| First-party matched, scored for recovery | 6,775 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.273%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,159 (31.867%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,776 (70.494%) |
| — still carrying decompiler local names | 1,987 (29.328%) |
