...
| Byte-identical functions | 7,919 (60.441% of windows) |
...
| In byte-exact linked C objects | 1,602 (12.227% of windows), with 207 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,289 C-matched (91.676%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,289 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.449%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,787 (28.415%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,311 (68.548%) |
| — still carrying decompiler local names | 1,924 (30.593%) |
