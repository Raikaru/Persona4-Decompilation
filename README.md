...
| Byte-identical functions | 7,721 (58.93% of windows) |
...
| First-party matched, scored for recovery | 6,755 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.28%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,155 (31.902%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,758 (70.437%) |
| — still carrying decompiler local names | 1,985 (29.386%) |
