...
| Byte-identical functions | 7,923 (60.472% of windows) |
...
| In byte-exact linked C objects | 1,603 (12.235% of windows), with 206 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,293 C-matched (91.735%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,293 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.447%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,787 (28.397%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,314 (68.552%) |
| — still carrying decompiler local names | 1,924 (30.574%) |
