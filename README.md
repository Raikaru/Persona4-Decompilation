...
| Byte-identical functions | 7,718 (58.907% of windows) |
...
| First-party matched, scored for recovery | 6,752 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.281%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,155 (31.916%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,753 (70.394%) |
| — still carrying decompiler local names | 1,984 (29.384%) |
