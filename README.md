...
| Byte-identical functions | 4,112 (31.423% of windows) |
| Under test (a `// FUN_` marker scores them) | 5,068 (38.728% of windows) |
| Not yet under test, supplied as retail bytes | 8,018 (61.272% of windows) |
| In byte-exact linked C objects | 1,239 (9.468% of windows), with 507 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,494 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.436%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,350 (38.638%) |
| — DOCUMENTED (prose, or trivially self-evident) | 2,187 (62.593%) |
| — still carrying decompiler local names | 794 (22.725%) |
