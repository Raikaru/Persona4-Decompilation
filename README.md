...
| Byte-identical functions | 7,751 (59.159% of windows) |
...
| First-party matched, scored for recovery | 6,785 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.27%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,164 (31.894%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,783 (70.494%) |
| — still carrying decompiler local names | 1,987 (29.285%) |
