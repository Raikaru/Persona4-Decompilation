...
| Byte-identical functions | 6,943 (52.996% of windows) |
...
| First-party matched, scored for recovery | 6,237 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.485%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,168 (34.76%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,266 (68.398%) |
| — still carrying decompiler local names | 1,713 (27.465%) |
