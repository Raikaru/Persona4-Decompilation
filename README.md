...
| Byte-identical functions | 7,810 (59.609% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,180 C-matched (90.087%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,180 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.492%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,770 (28.641%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,200 (67.961%) |
| — still carrying decompiler local names | 1,910 (30.906%) |
