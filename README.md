...
| Byte-identical functions | 7,752 (59.167% of windows) |
...
| — NAMED (not a `func_<address>` placeholder) | 154 (2.269%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,165 (31.904%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,783 (70.483%) |
| — still carrying decompiler local names | 1,987 (29.281%) |
