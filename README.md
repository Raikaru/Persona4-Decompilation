...
| Byte-identical functions | 7,892 (60.235% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,262 C-matched (91.283%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,262 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.459%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,784 (28.489%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,289 (68.492%) |
| — still carrying decompiler local names | 1,922 (30.693%) |
