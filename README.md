...
| Byte-identical functions | 7,739 (59.067% of windows) |
...
| In byte-exact linked C objects | 1,562 (11.922% of windows), with 246 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,773 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.274%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,159 (31.877%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,774 (70.486%) |
| — still carrying decompiler local names | 1,987 (29.337%) |
