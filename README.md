...
| Byte-identical functions | 7,926 (60.495% of windows) |
...
| In byte-exact linked C objects | 1,606 (12.258% of windows), with 203 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,296 C-matched (91.778%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,296 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.446%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,788 (28.399%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,317 (68.567%) |
| — still carrying decompiler local names | 1,924 (30.559%) |
