...
| Byte-identical functions | 3,888 (29.711% of windows) |
| In byte-exact linked C objects | 1,220 (9.323% of windows), with 523 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,270 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.74%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,242 (37.982%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,971 (60.275%) |
| — still carrying decompiler local names | 787 (24.067%) |
