...
| Byte-identical functions | 3,909 (29.872% of windows) |
| In byte-exact linked C objects | 1,233 (9.422% of windows), with 510 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,291 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.71%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,249 (37.952%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,984 (60.286%) |
| — still carrying decompiler local names | 789 (23.974%) |
