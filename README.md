...
| Byte-identical functions | 4,020 (30.72% of windows) |
| Under test (a `// FUN_` marker scores them) | 4,980 (38.056% of windows) |
| Not yet under test, supplied as retail bytes | 8,106 (61.944% of windows) |
| In byte-exact linked C objects | 1,235 (9.438% of windows), with 508 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,402 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.556%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,289 (37.889%) |
| — DOCUMENTED (prose, or trivially self-evident) | 2,095 (61.581%) |
| — still carrying decompiler local names | 792 (23.28%) |
