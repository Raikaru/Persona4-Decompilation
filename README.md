...
| Byte-identical functions | 7,499 (57.236% of windows) |
...
| — TYPED (no raw-offset or `M2C_` access) | 2,178 (32.1%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,788 (70.567%) |
| — still carrying decompiler local names | 1,986 (29.27%) |
