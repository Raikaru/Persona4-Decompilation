...
| Byte-identical functions | 7,748 (59.136% of windows) |
...
| In byte-exact linked C objects | 1,565 (11.945% of windows), with 243 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,782 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.271%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,162 (31.879%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,780 (70.481%) |
| — still carrying decompiler local names | 1,987 (29.298%) |
