...
| Byte-identical functions | 7,724 (58.953% of windows) |
...
| First-party matched, scored for recovery | 6,758 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.279%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,156 (31.903%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,761 (70.45%) |
| — still carrying decompiler local names | 1,985 (29.373%) |
