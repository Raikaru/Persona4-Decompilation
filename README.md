...
| Byte-identical functions | 7,784 (59.411% of windows) |
...
| First-party matched, scored for recovery | 6,818 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.259%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.857%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,807 (70.505%) |
| — still carrying decompiler local names | 1,986 (29.129%) |
