...
| Byte-identical functions | 7,734 (59.029% of windows) |
...
| First-party matched, scored for recovery | 6,768 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.275%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,158 (31.885%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,770 (70.479%) |
| — still carrying decompiler local names | 1,986 (29.344%) |
