...
| Under test (a `// FUN_` marker scores them) | 5,072 (38.759% of windows) |
| Not yet under test, supplied as retail bytes | 8,014 (61.241% of windows) |
...
| — DOCUMENTED (prose, or trivially self-evident) | 2,187 (62.521%) |
