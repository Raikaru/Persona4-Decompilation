...
| Byte-identical functions | 6,996 (53.401% of windows) |
...
| In byte-exact linked C objects | 1,428 (10.9% of windows), with 435 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,290 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.464%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,131 (33.879%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,329 (68.824%) |
| — still carrying decompiler local names | 1,784 (28.362%) |
