...
| Byte-identical functions | 7,709 (58.838% of windows) |
...
| First-party matched, scored for recovery | 6,743 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.284%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,149 (31.87%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,745 (70.369%) |
| — still carrying decompiler local names | 1,985 (29.438%) |
