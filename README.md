...
| Byte-identical functions | 7,762 (59.243% of windows) |
...
| In byte-exact linked C objects | 1,569 (11.975% of windows), with 239 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,796 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.266%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,171 (31.945%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,790 (70.483%) |
| — still carrying decompiler local names | 1,987 (29.238%) |
