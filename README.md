...
| Byte-identical functions | 7,903 (60.319% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,273 C-matched (91.443%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,273 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.455%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,785 (28.455%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,301 (68.564%) |
| — still carrying decompiler local names | 1,924 (30.671%) |
