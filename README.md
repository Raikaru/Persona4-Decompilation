...
| Byte-identical functions | 7,753 (59.174% of windows) |
...
| First-party matched, scored for recovery | 6,787 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.269%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,166 (31.914%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,784 (70.488%) |
| — still carrying decompiler local names | 1,987 (29.277%) |
