...
| Byte-identical functions | 7,876 (60.113% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,246 C-matched (91.05%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,246 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.466%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,783 (28.546%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,268 (68.332%) |
| — still carrying decompiler local names | 1,918 (30.708%) |
