...
| Byte-identical functions | 6,977 (53.255% of windows) |
...
| In byte-exact linked C objects | 1,426 (10.885% of windows), with 437 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,271 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.472%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,129 (33.95%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,312 (68.761%) |
| — still carrying decompiler local names | 1,770 (28.225%) |
