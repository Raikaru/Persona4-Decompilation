...
| Byte-identical functions | 3,896 (29.772% of windows) |
| In byte-exact linked C objects | 1,228 (9.384% of windows), with 515 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,278 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.728%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,246 (38.011%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,975 (60.25%) |
| — still carrying decompiler local names | 787 (24.009%) |
