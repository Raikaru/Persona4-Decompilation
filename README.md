...
| Byte-identical functions | 7,764 (59.258% of windows) |
...
| First-party matched, scored for recovery | 6,798 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.265%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.951%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,793 (70.506%) |
| — still carrying decompiler local names | 1,986 (29.214%) |
