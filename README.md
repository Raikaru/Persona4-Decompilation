...
| Byte-identical functions | 7,924 (60.479% of windows) |
...
| In byte-exact linked C objects | 1,604 (12.242% of windows), with 205 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,294 C-matched (91.749%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,294 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.447%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,787 (28.392%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,315 (68.557%) |
| — still carrying decompiler local names | 1,924 (30.569%) |
