...
| Byte-identical functions | 7,706 (58.815% of windows) |
...
| First-party matched, scored for recovery | 6,740 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.285%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,149 (31.884%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,741 (70.341%) |
| — still carrying decompiler local names | 1,984 (29.436%) |
