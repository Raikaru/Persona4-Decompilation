...
| Byte-identical functions | 4,117 (31.461% of windows) |
...
| In byte-exact linked C objects | 1,240 (9.476% of windows), with 508 assembly fallbacks still inside those objects |
