...
| Byte-identical functions | 7,729 (58.991% of windows) |
...
| First-party matched, scored for recovery | 6,763 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.277%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,157 (31.894%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,765 (70.457%) |
| — still carrying decompiler local names | 1,985 (29.351%) |
