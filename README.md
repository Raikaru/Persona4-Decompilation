...
| Byte-identical functions | 7,708 (58.831% of windows) |
...
| First-party matched, scored for recovery | 6,742 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.284%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,149 (31.875%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,744 (70.365%) |
| — still carrying decompiler local names | 1,984 (29.427%) |
