...
| Byte-identical functions | 6,823 (52.08% of windows) |
| Under test (a `// FUN_` marker scores them) | 13,101 (100.0% of windows) |
| Not yet under test, supplied as retail bytes | 0 (0.0% of windows) |
| In byte-exact linked C objects | 1,403 (10.709% of windows), with 472 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,151 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.52%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,139 (34.775%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,187 (68.07%) |
| — still carrying decompiler local names | 1,673 (27.199%) |
