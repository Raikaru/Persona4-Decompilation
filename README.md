...
| Byte-identical functions | 7,754 (59.182% of windows) |
...
| First-party matched, scored for recovery | 6,788 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.269%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,166 (31.909%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,785 (70.492%) |
| — still carrying decompiler local names | 1,987 (29.272%) |
