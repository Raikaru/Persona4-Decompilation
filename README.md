...
| Byte-identical functions | 7,843 (59.861% of windows) |
...
| In byte-exact linked C objects | 1,581 (12.067% of windows), with 227 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,213 C-matched (90.569%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,213 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.479%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,779 (28.634%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,232 (68.115%) |
| — still carrying decompiler local names | 1,912 (30.774%) |
