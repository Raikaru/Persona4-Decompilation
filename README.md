...
| Byte-identical functions | 7,908 (60.357% of windows) |
...
| In byte-exact linked C objects | 1,599 (12.204% of windows), with 210 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,278 C-matched (91.516%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,278 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.453%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,786 (28.449%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,305 (68.573%) |
| — still carrying decompiler local names | 1,924 (30.647%) |
