...
| Byte-identical functions | 3,540 (27.056% of windows) |
| In byte-exact linked C objects | 1,011 (7.727% of windows), with 739 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 2,922 |
| — NAMED (not a `func_<address>` placeholder) | 155 (5.305%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,180 (40.383%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,716 (58.727%) |
| — still carrying decompiler local names | 655 (22.416%) |
