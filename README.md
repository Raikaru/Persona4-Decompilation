...
| Byte-identical functions | 7,732 (59.014% of windows) |
...
| In byte-exact linked C objects | 1,560 (11.907% of windows), with 248 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,766 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.276%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,158 (31.895%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,768 (70.47%) |
| — still carrying decompiler local names | 1,986 (29.353%) |
