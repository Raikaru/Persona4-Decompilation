...
| Byte-identical functions | 7,772 (59.319% of windows) |
...
| First-party matched, scored for recovery | 6,806 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.263%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.913%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,800 (70.526%) |
| — still carrying decompiler local names | 1,986 (29.18%) |
