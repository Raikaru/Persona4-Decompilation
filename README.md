...
| Byte-identical functions | 7,722 (58.938% of windows) |
...
| First-party matched, scored for recovery | 6,756 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.279%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,156 (31.912%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,759 (70.441%) |
| — still carrying decompiler local names | 1,985 (29.381%) |
