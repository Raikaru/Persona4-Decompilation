...
| Byte-identical functions | 7,766 (59.273% of windows) |
...
| First-party matched, scored for recovery | 6,800 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.265%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.941%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,795 (70.515%) |
| — still carrying decompiler local names | 1,986 (29.206%) |
