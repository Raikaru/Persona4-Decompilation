...
| Byte-identical functions | 6,985 (53.317% of windows) |
...
| In byte-exact linked C objects | 1,427 (10.892% of windows), with 436 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,279 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.469%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,130 (33.923%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,319 (68.785%) |
| — still carrying decompiler local names | 1,777 (28.301%) |
