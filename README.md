...
| Byte-identical functions | 7,760 (59.228% of windows) |
...
| In byte-exact linked C objects | 1,567 (11.96% of windows), with 241 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,794 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.267%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,166 (31.881%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,790 (70.503%) |
| — still carrying decompiler local names | 1,987 (29.246%) |
