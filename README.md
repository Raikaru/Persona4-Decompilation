...
| Byte-identical functions | 7,765 (59.266% of windows) |
...
| First-party matched, scored for recovery | 6,799 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.265%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.946%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,794 (70.51%) |
| — still carrying decompiler local names | 1,986 (29.21%) |
