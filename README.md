...
| Byte-identical functions | 7,900 (60.296% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,270 C-matched (91.399%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,270 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.456%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,784 (28.453%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,298 (68.549%) |
| — still carrying decompiler local names | 1,923 (30.67%) |
