...
| Byte-identical functions | 7,895 (60.258% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,265 C-matched (91.327%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,265 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.458%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,784 (28.476%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,292 (68.508%) |
| — still carrying decompiler local names | 1,923 (30.694%) |
