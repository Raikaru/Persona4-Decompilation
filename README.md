...
| Byte-identical functions | 7,893 (60.243% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,263 C-matched (91.297%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,263 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.459%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,784 (28.485%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,290 (68.498%) |
| — still carrying decompiler local names | 1,923 (30.704%) |
