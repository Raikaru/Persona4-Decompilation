...
| Byte-identical functions | 3,902 (29.818% of windows) |
| In byte-exact linked C objects | 1,231 (9.407% of windows), with 512 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,284 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.72%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,246 (37.942%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,980 (60.292%) |
| — still carrying decompiler local names | 787 (23.965%) |
