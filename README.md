...
| Byte-identical functions | 7,863 (60.014% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,233 C-matched (90.86%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,233 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.471%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,782 (28.59%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,253 (68.234%) |
| — still carrying decompiler local names | 1,914 (30.708%) |
