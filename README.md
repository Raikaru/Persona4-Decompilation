...
| Byte-identical functions | 7,780 (59.38% of windows) |
...
| First-party matched, scored for recovery | 6,814 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.26%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.876%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,803 (70.487%) |
| — still carrying decompiler local names | 1,986 (29.146%) |
