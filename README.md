...
| Byte-identical functions | 7,714 (58.877% of windows) |
...
| — NAMED (not a `func_<address>` placeholder) | 154 (2.282%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,152 (31.891%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,749 (70.376%) |
| — still carrying decompiler local names | 1,985 (29.416%) |
