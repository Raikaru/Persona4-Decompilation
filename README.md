...
| Byte-identical functions | 6,980 (53.278% of windows) |
...
| — NAMED (not a `func_<address>` placeholder) | 155 (2.471%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,171 (34.603%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,305 (68.617%) |
| — still carrying decompiler local names | 1,729 (27.558%) |
