...
| Byte-identical functions | 7,720 (58.922% of windows) |
...
| — NAMED (not a `func_<address>` placeholder) | 154 (2.28%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,155 (31.907%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,757 (70.432%) |
| — still carrying decompiler local names | 1,984 (29.375%) |
