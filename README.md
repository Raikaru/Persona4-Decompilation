...
| Byte-identical functions | 3,887 (29.703% of windows) |
| In byte-exact linked C objects | 1,220 (9.323% of windows), with 523 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,269 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.742%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,242 (37.993%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,971 (60.294%) |
| — still carrying decompiler local names | 787 (24.075%) |
