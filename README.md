...
| Byte-identical functions | 7,746 (59.121% of windows) |
...
| First-party matched, scored for recovery | 6,780 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.271%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,160 (31.858%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,781 (70.516%) |
| — still carrying decompiler local names | 1,987 (29.307%) |
