...
| Byte-identical functions | 7,870 (60.067% of windows) |
...
| In byte-exact linked C objects | 1,587 (12.113% of windows), with 221 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,240 C-matched (90.962%); 1,767 linked (25.758%) |
