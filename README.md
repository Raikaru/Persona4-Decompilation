...
| Byte-identical functions | 4,124 (31.515% of windows) |
...
| In byte-exact linked C objects | 1,242 (9.491% of windows), with 506 assembly fallbacks still inside those objects |
