...
| Byte-identical functions | 3,882 (29.67% of windows) |
| In byte-exact linked C objects | 1,215 (9.286% of windows), with 528 assembly fallbacks still inside those objects |
