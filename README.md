...
| Byte-identical functions | 7,869 (60.06% of windows) |
...
| In byte-exact linked C objects | 1,586 (12.105% of windows), with 222 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,239 C-matched (90.948%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,239 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.468%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,783 (28.578%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,259 (68.264%) |
| — still carrying decompiler local names | 1,915 (30.694%) |
