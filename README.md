...
| Byte-identical functions | 7,483 (57.113% of windows) |
...
| First-party matched, scored for recovery | 6,769 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.29%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,175 (32.132%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,771 (70.483%) |
| — still carrying decompiler local names | 1,982 (29.281%) |
