...
| Byte-identical functions | 7,901 (60.304% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,271 C-matched (91.414%); 1,768 linked (25.773%) |
...
| — NAMED (not a `func_<address>` placeholder) | 154 (2.456%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,784 (28.448%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,299 (68.554%) |
| — still carrying decompiler local names | 1,924 (30.681%) |
