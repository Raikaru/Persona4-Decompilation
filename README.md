...
| Byte-identical functions | 3,748 (28.646% of windows) |
| In byte-exact linked C objects | 1,143 (8.736% of windows), with 600 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,131 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.95%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,220 (38.965%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,863 (59.502%) |
| — still carrying decompiler local names | 745 (23.794%) |
