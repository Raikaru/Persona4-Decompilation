...
| Canonical function windows | 13,100; all mapped to C or owned retail assembly |
| Byte-identical functions | 6,569 (50.145% of windows) |
| Under test (a `// FUN_` marker scores them) | 13,100 (100.0% of windows) |
| Not yet under test, supplied as retail bytes | 0 (0.0% of windows) |
| In byte-exact linked C objects | 1,400 (10.687% of windows), with 475 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 5,951 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.605%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,123 (35.675%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,031 (67.737%) |
| — still carrying decompiler local names | 1,537 (25.828%) |
