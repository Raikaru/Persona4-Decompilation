...
| Byte-identical functions | 7,925 (60.487% of windows) |
...
| In byte-exact linked C objects | 1,605 (12.25% of windows), with 204 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,295 C-matched (91.764%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,295 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.446%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,788 (28.403%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,316 (68.562%) |
| — still carrying decompiler local names | 1,924 (30.564%) |
