...
| Byte-identical functions | 7,462 (56.953% of windows) |
...
| First-party matched, scored for recovery | 6,748 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.297%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,168 (32.128%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,750 (70.391%) |
| — still carrying decompiler local names | 1,979 (29.327%) |
