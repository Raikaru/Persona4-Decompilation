...
| Byte-identical functions | 3,686 (28.172% of windows) |
| In byte-exact linked C objects | 1,096 (8.377% of windows), with 654 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,069 |
| — NAMED (not a `func_<address>` placeholder) | 155 (5.051%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,215 (39.589%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,812 (59.042%) |
| — still carrying decompiler local names | 718 (23.395%) |
