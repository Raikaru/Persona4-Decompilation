...
| Byte-identical functions | 7,461 (56.946% of windows) |
...
| In byte-exact linked C objects | 1,544 (11.784% of windows), with 323 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,747 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.297%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,168 (32.133%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,749 (70.387%) |
| — still carrying decompiler local names | 1,979 (29.332%) |
