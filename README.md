...
| Byte-identical functions | 7,723 (58.945% of windows) |
...
| In byte-exact linked C objects | 1,557 (11.884% of windows), with 251 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 6,757 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.279%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,156 (31.908%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,760 (70.445%) |
| — still carrying decompiler local names | 1,985 (29.377%) |
