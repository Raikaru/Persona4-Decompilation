...
| Byte-identical functions | 7,774 (59.334% of windows) |
...
| First-party matched, scored for recovery | 6,808 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.262%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,172 (31.904%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,800 (70.505%) |
| — still carrying decompiler local names | 1,986 (29.172%) |
