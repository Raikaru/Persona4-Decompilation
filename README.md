...
| Byte-identical functions | 7,922 (60.464% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,292 C-matched (91.72%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,292 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.448%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,787 (28.401%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,313 (68.547%) |
| — still carrying decompiler local names | 1,924 (30.579%) |
