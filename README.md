...
| Byte-identical functions | 7,871 (60.075% of windows) |
...
| In byte-exact linked C objects | 1,588 (12.12% of windows), with 220 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,241 C-matched (90.977%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,241 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.468%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,783 (28.569%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,263 (68.306%) |
| — still carrying decompiler local names | 1,915 (30.684%) |
