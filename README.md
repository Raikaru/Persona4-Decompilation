...
| Byte-identical functions | 6,978 (53.263% of windows) |
...
| — TYPED (no raw-offset or `M2C_` access) | 2,171 (34.614%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,304 (68.622%) |
| — still carrying decompiler local names | 1,727 (27.535%) |
