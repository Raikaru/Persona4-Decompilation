...
| Byte-identical functions | 3,719 (28.424% of windows) |
| In byte-exact linked C objects | 1,118 (8.545% of windows), with 632 assembly fallbacks still inside those objects |
| First-party matched, scored for recovery | 3,102 |
| — NAMED (not a `func_<address>` placeholder) | 155 (4.997%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,218 (39.265%) |
| — DOCUMENTED (prose, or trivially self-evident) | 1,838 (59.252%) |
| — still carrying decompiler local names | 731 (23.565%) |
