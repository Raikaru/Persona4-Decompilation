...
| Byte-identical functions | 7,864 (60.021% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,234 C-matched (90.875%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,234 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.47%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,782 (28.585%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,254 (68.239%) |
| — still carrying decompiler local names | 1,914 (30.703%) |
