...
| Byte-identical functions | 4,119 (31.476% of windows) |
...
| In byte-exact linked C objects | 1,241 (9.483% of windows), with 507 assembly fallbacks still inside those objects |
