...
| Byte-identical functions | 7,511 (57.327% of windows) |
...
| First-party matched, scored for recovery | 6,797 |
| — NAMED (not a `func_<address>` placeholder) | 155 (2.28%) |
| — TYPED (no raw-offset or `M2C_` access) | 2,182 (32.102%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,799 (70.605%) |
| — still carrying decompiler local names | 1,989 (29.263%) |
