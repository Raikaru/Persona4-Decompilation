...
| Byte-identical functions | 7,921 (60.456% of windows) |
...
| Atlus game/engine | 6,860 functions; 6,291 C-matched (91.706%); 1,768 linked (25.773%) |
...
| First-party matched, scored for recovery | 6,291 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.448%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,787 (28.406%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,312 (68.542%) |
| — still carrying decompiler local names | 1,924 (30.583%) |
