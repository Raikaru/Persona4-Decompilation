...
| Byte-identical functions | 7,861 (59.998% of windows) |
...
| In byte-exact linked C objects | 1,584 (12.09% of windows), with 224 assembly fallbacks still inside those objects |
| Atlus game/engine | 6,860 functions; 6,231 C-matched (90.831%); 1,767 linked (25.758%) |
...
| First-party matched, scored for recovery | 6,231 |
| — NAMED (not a `func_<address>` placeholder) | 154 (2.472%) |
| — TYPED (no raw-offset or `M2C_` access) | 1,782 (28.599%) |
| — DOCUMENTED (prose, or trivially self-evident) | 4,251 (68.223%) |
| — still carrying decompiler local names | 1,914 (30.717%) |
