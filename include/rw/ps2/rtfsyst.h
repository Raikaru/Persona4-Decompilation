/*
  * rtfsyst.h - RenderWare file system toolkit, PlayStation 2 configuration.
  *
  * The 3.7.0.2 tree ships the Windows-configured public header; this is the
  * same file with the ./win/fsystplatform.h section (windows.h, critical
  * sections) left out. The sky2 platform section is not in the tree; nothing
  * in the ported block needs it.
  */
...
#if (defined(WIN32) || defined(MACOS) || defined(PSP_DRVMODEL_H))
