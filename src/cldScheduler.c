...
extern s32 scrFindPrcdIdxByName(s32 a, void *b);
    ...
    case 0:
        ...
        else
        {
            ...
            period = func_001060c0() & 0xFF;
            {
                ...
                sprintf(buf70, D_00637310, v3, v4, labels[period & 0xFF]);
            }
            if (D_007637A0 == -1)
            {
                a = 0;
            ...
            ret = scrFindPrcdIdxByName(a, buf70);
            if (ret == -1)
            {
        ...
        break;
    case 1:
        if (H_Cdvd_IsFileLoaded((u8 *)D_00764578) != 0)
        {
            ...
            memset((void *)D_0076457C, 0, 0x20000);
            memcpy((void *)D_0076457C, (void *)b, (u32)a);
            H_Cdvd_Destroy((void *)D_00764578);
            D_00764578 = 0;
            flag2 = 1;
        }
        else
