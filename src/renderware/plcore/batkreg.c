/* batkreg.c - RenderWare Graphics 3.7.0.2 core/src/plcore/batkreg.c, verbatim;
...
#define RwFreeListForAllUsed func_003e18c0
#define RwFreeListDestroy func_003e12f0
#define _rwGetNumEngineInstances func_003e8910
...
extern RwFreeList *toolkitRegEntries;
extern RwFreeList toolkitRegEntriesSpace;  /* P4: file static, at its retail address */

static RwPluginRegistry **toolkitNonFLRegList = (RwPluginRegistry **)NULL;

extern RwUInt32 numRegToolkits;  /* P4: file static, at its retail address */

/****************************************************************************
 Functions
 */

extern RwInt32 _rwPluginRegFreeListBlockSize;
extern RwInt32 _rwPluginRegListPreallocBlocks;  /* P4: file static, at its retail address */
