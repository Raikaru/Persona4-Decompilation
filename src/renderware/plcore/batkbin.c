/* batkbin.c - RenderWare Graphics 3.7 plugin binary data (core/src/plcore/batkbin.c),
 * ported verbatim and verified byte-exact against retail with MWCCPS2 3.0.1 b119.
 */
...
/* Callees not yet in this unit are aliased to their retail symbols. */
