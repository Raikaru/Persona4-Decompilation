/* resmem.c - RenderWare Graphics 3.7.0.2 core/src/plcore/resmem.c, verbatim;
...
extern RwInt32 nAccessCount;  /* P4: file static, at its retail address */
extern void *nGLogFileID;  /* P4: file static, at its retail address */
extern RwUInt32 nGAddressBuffer[MEMLOGBUFFERSIZE];  /* P4: file static, at its retail address */
extern RwUInt8 nGAccessBuffer[MEMLOGBUFFERSIZE];  /* P4: file static, at its retail address */
extern RwUInt32 nGCountBuffer[MEMLOGBUFFERSIZE];  /* P4: file static, at its retail address */
extern RwUInt32 nGSizeBuffer[MEMLOGBUFFERSIZE];  /* P4: file static, at its retail address */
extern RwUInt32 nGBufferIndex;  /* P4: file static, at its retail address */
extern char sGOutputString[MEMLOGBUFFERSIZE *
                                   MEMLOGTEXTENTRYSIZEMAX];  /* P4: file static, at its retail address */
...
extern RwUInt8 *heapEnd;  /* P4: file static, at its retail address */
