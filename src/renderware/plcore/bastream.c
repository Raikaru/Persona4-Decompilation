/* bastream.c - RenderWare Graphics 3.7.0.2 core/src/plcore/bastream.c, verbatim;
...
#define RwFopen func_003dddf0
#define _rwerror func_003df590
#define RwFtell func_003de270
#define memcpy func_0043f810
#define RwFread func_003ddf80
#define RwFeof func_003de100
#define RwFwrite func_003ddfd0
#define RwFseek func_003de020
#define RwFclose func_003ddf20
 ...
 */
extern RwModuleInfo streamModule;  /* P4: file static, at its retail address */
...
extern RwInt32 _rwStreamFreeListBlockSize;
extern RwInt32 _rwStreamFreeListPreallocBlocks;  /* P4: file static, at its retail address */
extern RwFreeList _rwStreamFreeList;  /* P4: file static, at its retail address */
