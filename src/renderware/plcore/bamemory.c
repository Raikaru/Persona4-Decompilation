/* bamemory.c - RenderWare Graphics 3.7.0.2 core/src/plcore/bamemory.c, verbatim;
...
#define RwFreeListPurge func_003e1740
...
/****************************************************************************
 Local Defines
*/
extern RwBool FreeListsEnabled;  /* P4: file static, at its retail address */
...
extern RwBool _freeListModuleOpen;  /* P4: file static, at its retail address */
extern RwFreeList _masterFreeList;  /* P4: file static, at its retail address */ /* free list for the free lists */
extern RwFreeList *_masterFreeListPtr;  /* P4: file static, at its retail address */
