/* baplcore.c - RenderWare Graphics 3.7.0.2 core/src/plcore/baplcore.c, verbatim;
...
#define _rwPluginRegistryGetPluginOffset func_003e3830
#define _rwDeviceGetHandle func_00401450
 ...
 */
extern const char _rwBuildDateTime[] __RWUNUSED__;  /* P4: file static, at its retail address */
...
extern RwUInt32 engineInstancesOpened;  /* P4: file static, at its retail address */
...
extern RwGlobals staticGlobals;  /* P4: file static, at its retail address */
#else /* RWGLOBALSIZE */
...
extern _CrtMemState _InitialMemState;  /* P4: file static, at its retail address */
