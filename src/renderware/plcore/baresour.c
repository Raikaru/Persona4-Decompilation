/* baresour.c - RenderWare Graphics 3.7.0.2 core/src/plcore/baresour.c, verbatim;
...
#define _rwResHeapInit func_003e44b0
#define _rwerror func_003df590
#define RwResourcesEmptyArena func_003e2430
#define _rwResHeapClose func_003e4510
#define _rwResHeapFree func_003e4520
