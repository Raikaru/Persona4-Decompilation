/* babinfrm.c - RenderWare Graphics 3.7.0.2 core/src/babinfrm.c, verbatim;
...
#define RwFrameCount func_003e9b60
...
#define RwFrameCreate func_003e9320
#define _rwMatrixNormalError func_003e01e0
#define RwFrameAddChild func_003e9830
 ...
 */
extern RwBool _rwFrameListDirtyListUpdate;  /* P4: file static, at its retail address */
