/* baraster.c - RenderWare Graphics 3.7.0.2 core/src/baraster.c, verbatim;
...
#define _rwResourcesPurge func_003e1f50
...
extern RwModuleInfo rasterModule;  /* P4: file static, at its retail address */
...
extern RwInt32 _rwRasterFreeListBlockSize;
extern RwInt32 _rwRasterFreeListPreallocBlocks;  /* P4: file static, at its retail address */
extern RwFreeList _rwRasterFreeList;  /* P4: file static, at its retail address */
