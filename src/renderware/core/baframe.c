/* baframe.c - RenderWare Graphics 3.7.0.2 core/src/baframe.c, verbatim;
...
#define rwFrameInternalInit func_003e9250
#define _rwPluginRegistryDeInitObject func_003e3c20
#define RwFrameRemoveChild func_003e99a0
#define _rwFrameSyncHierarchyLTM func_003ed960
#define RwMatrixTranslate func_003e0870
...
extern RwModuleInfo frameModule;  /* P4: file static, at its retail address */

extern RwInt32 _rwFrameFreeListBlockSize;
extern RwInt32 _rwFrameFreeListPreallocBlocks;  /* P4: file static, at its retail address */
