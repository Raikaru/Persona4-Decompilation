/* babincam.c - RenderWare Graphics 3.7.0.2 core/src/babincam.c, verbatim;
...
#define RwCameraSetFarClipPlane func_003e81c0
#define RwCameraSetProjection func_003e8310
