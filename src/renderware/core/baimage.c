/* baimage.c - RenderWare Graphics 3.7.0.2 core/src/baimage.c, verbatim;
...
#define RwImageSetGamma func_003ebff0
...
extern RwModuleInfo imageModule;  /* P4: file static, at its retail address */
...
extern RwInt32 _rwImageFreeListBlockSize;
extern RwInt32 _rwImageFreeListPreallocBlocks;  /* P4: file static, at its retail address */
extern RwFreeList _rwImageFreeList;  /* P4: file static, at its retail address */
...
extern RwInt32 _rwImageFormatFreeListBlockSize;
extern RwInt32 _rwImageFormatFreeListPreallocBlocks;  /* P4: file static, at its retail address */
extern RwFreeList _rwImageFormatFreeList;  /* P4: file static, at its retail address */
