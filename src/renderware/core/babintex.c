/* babintex.c - RenderWare Graphics 3.7.0.2 core/src/babintex.c, verbatim;
...
#define _rwStringStreamGetSize func_003e4ad0
#define _rwStreamWriteVersionedChunkHeader func_003deff0
#define RwStreamWrite func_003e2ab0
#define _rwStringStreamWrite func_003e4b20
#define RwStreamFindChunk func_003df050
#define memset func_0043f9c8
#define RwStreamRead func_003e2910
#define RwTextureGetMipmapping func_003ef020
#define RwTextureGetAutoMipmapping func_003ef060
#define RwTextureSetMipmapping func_003ef000
...
#define RwTexDictionaryCreate func_003ef0d0
#define RwTexDictionaryDestroy func_003ef1b0
#define RwTexDictionaryAddTexture func_003ef5b0
