/* bapipew.c - RenderWare Graphics 3.7.0.2 world/pipe/p2/bapipew.c source mirror.
...
/* P4: the proprietary sky2 fast-immediate header is absent; select the
   source tree's null-platform declarations for this unowned unit. */
