/* bamateri.c - RenderWare Graphics 3.7.0.2 world/bamateri.c, verbatim;
...
extern RwModuleInfo materialModule;  /* P4: file static, at its retail address */
...
extern RwInt32 _rpMaterialFreeListBlockSize;
extern RwInt32 _rpMaterialFreeListPreallocBlocks;  /* P4: file static, at its retail address */
extern RwFreeList _rpMaterialFreeList;  /* P4: file static, at its retail address */
