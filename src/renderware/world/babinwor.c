/* babinwor.c - RenderWare Graphics 3.7.0.2 world/babinwor.c, verbatim;
...
#define RwStreamReadInt32 func_003df360
...
extern RwModuleInfo binWorldModule;  /* P4: file static, at its retail address */
...
extern RwUInt32 lastSeenWorldRightsPluginId;  /* P4: file static, at its retail address */
extern RwUInt32 lastSeenWorldExtraData;  /* P4: file static, at its retail address */
...
extern RwUInt32 lastSeenSectRightsPluginId;  /* P4: file static, at its retail address */
extern RwUInt32 lastSeenSectExtraData;  /* P4: file static, at its retail address */
