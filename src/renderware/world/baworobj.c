/* baworobj.c - RenderWare Graphics 3.7.0.2 world/baworobj.c, verbatim;
...
#define RpWorldAddLight func_003cbe80
#define _rpMeshWrite func_003c5a90
#define _rpMeshRead func_003c5d10
#define _rpGeometryNativeRead func_003cebb0
#define RpWorldSectorGetWorld func_003c9c20
#define _rpMeshSize func_003c5fd0
...
extern RwInt32 cameraExtOffset;  /* P4: file static, at its retail address */
extern RwInt32 atomicExtOffset;  /* P4: file static, at its retail address */
extern RwInt32 clumpExtOffset;  /* P4: file static, at its retail address */
extern RwInt32 lightExtOffset;  /* P4: file static, at its retail address */
extern RwModuleInfo worldObjModule;  /* P4: file static, at its retail address */
...
extern RwInt32 _rpTieFreeListBlockSize;
extern RwInt32 _rpTieFreeListPreallocBlocks;  /* P4: file static, at its retail address */
extern RwFreeList _rpTieFreeList;  /* P4: file static, at its retail address */
...
extern RwInt32 _rpLightTieFreeListBlockSize;
extern RwInt32 _rpLightTieFreeListPreallocBlocks;  /* P4: file static, at its retail address */
extern RwFreeList _rpLightTieFreeList;  /* P4: file static, at its retail address */
