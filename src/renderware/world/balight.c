/* balight.c - RenderWare Graphics 3.7.0.2 world/balight.c, verbatim;
...
extern RwModuleInfo lightModule;  /* P4: file static, at its retail address */
...
extern RwInt32 _rpLightFreeListBlockSize;
extern RwInt32 _rpLightFreeListPreallocBlocks;  /* P4: file static, at its retail address */
extern RwFreeList _rpLightFreeList;  /* P4: file static, at its retail address */
