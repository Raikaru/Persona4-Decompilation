/* baworld.c - RenderWare Graphics 3.7.0.2 world/baworld.c, verbatim;
...
#define _rpTieDestroy func_003ca9d0
#define _rpLightTieDestroy func_003ca960
...
extern RwModuleInfo worldModule;  /* P4: file static, at its retail address */
...
extern RwFreeList _rpWorldListFreeList;  /* P4: file static, at its retail address */
