/* bageomet.c - RenderWare Graphics 3.7.0.2 world/bageomet.c, verbatim;
...
#define _rpMaterialListFindMaterialIndex func_003c4bc0
#define _rpMaterialListAppendMaterial func_003c4a80
#define GeometryStreamGetSizeActual func_003c2bd0
#define _rpMaterialListStreamGetSize func_003c4c00
#define RwStreamFindChunk func_003df050
#define _rwerror func_003df590
#define RwStreamRead func_003e2910
#define RpGeometryCreate func_003c2630
#define RwStreamReadReal func_003df300
...
static RwPluginRegistry geometryTKList =
    { sizeof(RpGeometry),
      ...
      (RwPluginRegEntry *) NULL };
extern RwModuleInfo geometryModule;  /* P4: file static, at its retail address */
