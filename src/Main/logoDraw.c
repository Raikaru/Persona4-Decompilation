...
s32 func_0012bbb0(s32 arg0)
{
    ...
    case 1:
        temp_2->state = 2;
        func_00440b68(&D_00762D98, &D_005E5730, 0xB5);
        temp_2->handle = func_00454a60(D_005E5760, 1);
        /* fallthrough */
    case 2:
        if (func_004553c0(temp_2->handle) != 0) {
            temp_2->state = 3;
            func_0044ea90(&D_005E5730, 0x4D);
            temp_2_3 = D_008873F4[0](1, 0xC, 0x40000);
            *(s32 *)temp_2_3 = 0;
            *(s32 *)((u8 *)temp_2_3 + 4) = func_004667d0(0, D_005E5770, 0, 0, 0, 0, 0, 0, 0, 0);
            temp_2->task10 = func_00451de0(&D_00762D88, 0x100, 0, 0, func_0012b890, func_0012b940, temp_2_3);
            func_0044ea90(&D_005E5730, 0x4D);
            temp_2_4 = D_008873F4[0](1, 0xC, 0x40000);
            *(s32 *)temp_2_4 = 0;
            *(s32 *)((u8 *)temp_2_4 + 4) = func_004667d0(0, D_005E5790, 0, 0, 0, 0, 0, 0, 0, 0);
            temp_2->task14 = func_00451de0(&D_00762D88, 0x100, 0, 0, func_0012b890, func_0012b940, temp_2_4);
        }
        break;
    case 3:
        temp_19 = temp_2->task10;
        temp_18 = func_00452560(temp_19);
        ...
        if (var_2 != 0) {
            ...
            temp_18_2 = func_00452560(temp_19_2);
    ...
    *(void **)((u8 *)temp_2_7 + 8) = func_0012b9a0;
    *(void **)((u8 *)temp_2_7 + 0x10) = (void *)arg0;
