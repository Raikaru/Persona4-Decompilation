...
/* measured: nd 0 (1800-byte object in the 1808-byte window, zero tail).
   Recipe: the 14ef0 contract (s16 argument, s8 mode forwarded unconverted);
   an s16 `base` spilled at 0xC0 with an s32 `order` copy in $s4; the 0x160
   branch builds its points and colours inside the 77d0 arguments
   (struct-return 2970). In the 0x174 row loop retail counts in the register
   of the early resource id and carries each row resource in `base`'s web:
   `for (id = 0, o2 = order + 4; ...) { r = id + 0x174; base = r; ... }`.
   A fresh loop counter or resource local leaves a three-register rotation
   (13 words) or is propagated away. opt_loop_invariants hoists the row
   floats to the preheader. The row colour locals are assigned inside the
   77d0 arguments only to give the colour temporaries their retail stack
   homes (dropping them costs 8 words). */
#pragma push
...
void func_00316470(u8 *arg0, s64 arg1, s64 arg2) {
    ...
    if ((s8)arg2 == 0) {
        ...
        *(FclByte4 *)(p + 0x85) = c16C;
        ...
        f20 = 300.0f;
        spA8 = func_002b2970(f20 + sp158.x, sp158.y);
        func_002b69f0(0x69, sp158, spA8, 0, 0xA, 0);
    }
    b = (FclVec2 *)D_00644AD8;
    sp158 = func_002b2970(b->x, b->y);
    if ((s8)arg2 == 0) {
        spA0 = func_002b2970(b->x, b->y);
        func_002b6c30(0x1AD, spA0, 100.0f, 0x41);
        sp98 = func_002b2970(f20 + b->x, b->y);
        sp90 = func_002b2970(b->x, b->y);
    ...
    if ((func_00104c70(1) & 0xFF) / 10 > 0) {
        if ((s8)arg2 == 0) {
            ...
            *(s16 *)(func_002b6150(0x26F) + 4) = (s16)((func_00104c70(1) & 0xFF) / 10 + 0x46);
            sp58 = func_002b2970(f20 + sp158.x, sp158.y);
            func_002b69f0(0x26F, sp58, sp158, 0, 0xA, 0);
        } else {
            sp50 = func_002b2970(f20 + sp158.x, sp158.y);
...
void func_003191c0(u8 *arg0, FclVec2 arg1, s32 arg2, s32 arg3, s16 arg4, s32 arg5, s32 arg6, s8 arg7) {
    ...
    if ((s8)arg6 == 1) {
        ...
        if (special == 1) {
            c298 = func_002b2a60(0x8C, 0xE2, 0xFF, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c298;
            func_002b6a70(id, 0, 0xFF, 0, 0, arg5);
        } else if (*(s16 *)(t + 0x11E) == c) {
            c294 = func_002b2a60(0xCC, 0xFF, 0x33, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c294;
            func_002b6a70(id, 0, 0xFF, 0, 0, arg5);
        } else {
            c290 = func_002b2a60(0x49, 0x72, 0xFF, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c290;
            func_002b6a70(id, 0, 0x66, 0, 0, arg5);
        }
        sc = iGpffff8504;
        func_002b6af0(id, 1.0f, 1.0f, sc, 1.0f, 0, 3, arg5);
        func_002b69f0(id, func_002b2970(arg1.x, arg1.y + func_0046b2f0(hA) / 2.0f), func_002b2970(arg1.x, arg1.y), 0, 3, arg5);
    }
    func_0046d280(hA);
    id = (s16)(c + 0x22B);
    ...
    if ((s8)arg6 == 1) {
        ...
        func_002b6c30(id, func_002b2970(301 + arg1.x, y), 192.0f, 0x57);
        if (special == 1) {
            c28C = func_002b2a60(0x8C, 0xE2, 0xFF, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c28C;
            func_002b6a70(id, 0, 0xFF, 0, 0, arg5);
        } else if (*(s16 *)(t + 0x11E) == c) {
            c288 = func_002b2a60(0xCC, 0xFF, 0x33, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c288;
            func_002b6a70(id, 0, 0xFF, 0, 0, arg5);
        } else {
            c284 = func_002b2a60(0x49, 0x72, 0xFF, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c284;
            func_002b6a70(id, 0, 0x66, 0, 0, arg5);
        }
        func_002b6af0(id, 1.0f, 1.0f, sc, 1.0f, 0, 3, arg5);
        func_002b69f0(id, func_002b2970(301 + arg1.x, arg1.y + func_0046b2f0(hB) / 2.0f), func_002b2970(301 + arg1.x, arg1.y), 0, 3, arg5);
    }
    func_0046d280(hB);
    id = (s16)(c + 0x238);
    ...
    if ((s8)arg6 == 1) {
        ...
        func_002b6c30(id, func_002b2970(arg1.x, arg1.y), 163.0f, 0x57);
        func_002b6a70(id, 0, 0xFF, 0, 0, arg5);
        func_002b6af0(id, 1.0f, 1.0f, sc, 1.0f, 0, 3, arg5);
        func_002b69f0(id, func_002b2970(arg1.x, arg1.y + func_0046b2f0(hC) / 2.0f), func_002b2970(arg1.x, arg1.y), 0, 3, arg5);
        if (special == 1) {
            c280 = func_002b2a60(0x8C, 0xE2, 0xFF, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c280;
        } else if (*(s16 *)(t + 0x11E) == c) {
            c27C = func_002b2a60(0xCC, 0xFF, 0x33, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c27C;
        } else {
            c278 = func_002b2a60(0x49, 0x72, 0xFF, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c278;
            if (arg7 <= c) {
                c274 = func_002b2a60(0x24, 0x3F, 0x9F, 0xFF);
                *(FclByte4 *)(func_002b6150(id) + 0x85) = c274;
            }
        }
    }
    func_0046d280(hC);
    ...
    if ((s8)arg6 == 1) {
        ...
        func_002b6c30(id, func_002b2970(55.0f + arg1.x, arg1.y), 163.0f, 0x57);
        func_002b6a70(id, 0, 0xFF, 0, 0, arg5);
        func_002b6af0(id, 1.0f, 1.0f, sc, 1.0f, 0, 3, arg5);
        func_002b69f0(id, func_002b2970(55.0f + arg1.x, arg1.y + func_0046b2f0(hD) / 2.0f), func_002b2970(55.0f + arg1.x, arg1.y), 0, 3, arg5);
        if (special == 1) {
            c270 = func_002b2a60(0x8C, 0xE2, 0xFF, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c270;
        } else if (*(s16 *)(t + 0x11E) == c) {
            c26C = func_002b2a60(0xCC, 0xFF, 0x33, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c26C;
        } else {
            c268 = func_002b2a60(0x49, 0x72, 0xFF, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c268;
            if (arg7 <= c) {
                c264 = func_002b2a60(0x24, 0x3F, 0x9F, 0xFF);
                *(FclByte4 *)(func_002b6150(id) + 0x85) = c264;
            }
        }
    }
    func_0046d280(hD);
    if (*(s16 *)(t + 0x11E) == c) {
        func_002b83e0(func_0034ae50(*(u8 **)(t + 0x188), arg2), func_002b2970(arg1.x, y),
                      (c260 = func_002b2a60(0xCC, 0xFF, 0x33, 0xFF)), (c25C = func_002b2a60(0xCC, 0xFF, 0x33, 0xFF)),
                      0xFF, 0xFF, 32.0f, 159.0f, 3, (s16)arg5, arg6, 0);
    } else if (special == 1) {
        func_002b83e0(func_0034ae50(*(u8 **)(t + 0x188), arg2), func_002b2970(arg1.x, y),
                      *(FclDrawColor *)(func_0034ae50(*(u8 **)(t + 0x188), arg2) + 0x75),
                      *(FclDrawColor *)(func_0034ae50(*(u8 **)(t + 0x188), arg2) + 0x75),
                      0xFF, 0xFF, 32.0f, 159.0f, 3, (s16)arg5, arg6, 0);
    } else {
        func_002b83e0(func_0034ae50(*(u8 **)(t + 0x188), arg2), func_002b2970(arg1.x, y),
                      (c258 = func_002b2a60(0, 0, 0x99, 0xFF)), (c254 = func_002b2a60(0, 0, 0x99, 0xFF)),
                      0xFF, 0xFF, 32.0f, 159.0f, 3, (s16)arg5, arg6, 0);
    }
    n = (s8)arg2 + 0x39;
    id = (s16)n;
    ...
    if ((s8)arg6 == 1) {
        ...
        func_002b6c30(id, func_002b2970(4.0f + arg1.x, 5.0f + arg1.y), 158.0f, 0x59);
        if (special == 1) {
            c250 = func_002b2a60(0, 0, 0x66, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c250;
        } else if (*(s16 *)(t + 0x11E) == c) {
            c24C = func_002b2a60(0x2D, 0x2D, 0x2D, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c24C;
        } else {
            c248 = func_002b2a60(0x8C, 0xE2, 0xFF, 0xFF);
            *(FclByte4 *)(func_002b6150(id) + 0x85) = c248;
        }
        func_002b6a70(id, 0, 0xFF, 0, 0, arg5);
        func_002b6af0(id, 1.0f, 1.0f, sc, 1.0f, 0, 3, arg5);
        func_002b69f0(id, func_002b2970(4.0f + arg1.x, 5.0f + arg1.y + func_0046b2f0(h2) / 2.0f), func_002b2970(4.0f + arg1.x, 5.0f + arg1.y), 0, 3, arg5);
    }
    func_0046d280(h2);
    if (c < arg7) {
        id = (s16)(c + 0x250);
        ...
        if ((s8)arg6 == 1) {
            ...
            func_002b6c30(id, func_002b2970(28.0f + arg1.x, 2.0f + arg1.y), 46.0f, 0x59);
            *(s16 *)(func_002b6150(id) + 4) = (s16)((func_00109280(arg3) & 0xFF) + 0x1B);
            if (special == 1) {
                c244 = func_002b2a60(0, 0, 0x66, 0xFF);
                *(FclByte4 *)(func_002b6150(id) + 0x85) = c244;
            } else if (*(s16 *)(t + 0x11E) == c) {
                c240 = func_002b2a60(0x2D, 0x2D, 0x2D, 0xFF);
                *(FclByte4 *)(func_002b6150(id) + 0x85) = c240;
            } else {
                c23C = func_002b2a60(0, 0, 0x66, 0xFF);
                *(FclByte4 *)(func_002b6150(id) + 0x85) = c23C;
            }
            func_002b6a70(id, 0, 0xFF, 0, 0, arg5);
            func_002b6af0(id, 1.0f, 1.0f, sc, 1.0f, 0, 3, arg5);
            func_002b69f0(id, func_002b2970(28.0f + arg1.x, 2.0f + arg1.y + func_0046b2f0(h3) / 2.0f), func_002b2970(28.0f + arg1.x, 2.0f + arg1.y), 0, 3, arg5);
        }
        func_0046d280(h3);
        if (special == 1) {
            c29C = func_002b2a60(0, 0, 0x66, 0xFF);
        } else if (*(s16 *)(t + 0x11E) == c) {
            c29C = func_002b2a60(0x2D, 0x2D, 0x2D, 0xFF);
        } else if (arg4 == 0) {
            c29C = func_002b2a60(0xCC, 0xFF, 0xFF, 0x80);
        } else {
    ...
    if ((s8)arg6 == 1) {
        func_0034b880(((u8 **)(t + 0x21C))[c], 0xFF, 0, 0, 3, arg5);
    } else {
        c2 = (s8)arg2;
        pp = (u8 **)(t + 0x21C) + c2;
        func_0034b820(*pp, func_002b2970(30.0f + arg1.x, 7.0f + y), 0x59, func_002b2a60(0, 0, 0x66, 0xFF), 157.0f);
        func_0034b880(*pp, 0, 0xFF, 0, 3, arg5);
        *(s8 *)(func_0034b810(*pp) + 0xF00) = 0;
        if (*(s16 *)(t + 0x11E) == c2) {
            *(s8 *)(func_0034b810(*pp) + 0xF00) = 1;
        }
    }
...
void func_003205f0(u8 *arg0, s64 arg1, s64 arg2) {
    ...
    if (idx1 != 0) {
        ...
        spA0 = func_002b2970(tbl1->x - 200.0f, tbl1->y);
        func_002b6c30(arg1, spA0, 54.0f, 0xAC);
        sp98 = func_002b2970(tbl1->x - 200.0f, tbl1->y);
        sp90 = func_002b2970(tbl1->x, tbl1->y);
        func_002b69f0(arg1, sp98, sp90, 0, 0xA, 0);
        func_002b6a70(arg1, 0, 0xFF, 0, 0xA, 0);
        if (idx1 == 0x92) {
            ca = (f2 *)D_00644CA0;
            sp88 = func_002b2970(ca->x, ca->y);
            func_002b6c30(0x1E6, sp88, 54.0f, 0x65);
            sp80 = func_002b2970(58.0f, ca->y);
            sp78 = func_002b2970(ca->x, ca->y);
    ...
    if (idx2 != 0) {
        ...
        sp70 = func_002b2970(tbl2->x, tbl2->y);
        func_002b6c30(arg2, sp70, 54.0f, 0xAC);
        sp68 = func_002b2970(tbl2->x, tbl2->y);
        sp60 = func_002b2970(200.0f + tbl2->x, tbl2->y);
        func_002b69f0(arg2, sp68, sp60, 0, 0xA, 0);
        func_002b6a70(arg2, 0xFF, 0, 0, 0xA, 0);
        if (idx2 == 0x92) {
            ca = (f2 *)D_00644CA0;
            sp58 = func_002b2970(ca->x, ca->y);
            sp50 = func_002b2970(122.0f, ca->y);
...
void func_003218a0(u8 *arg0, s32 arg1) {
    ...
    for (; i < (u16)func_0010b5b0(); i++) {
        ...
        xx = x + 0x14E;
        func_002b69f0(r, func_002b2970(xx, 110.0f + func_0046b2f0(h) / 2.0f), func_002b2970(xx, 110.0f), 0, 3, arg1);
...
void func_00324410(u8 *arg0, s16 arg1, s8 arg2) {
    ...
    case 0:
        ...
        if (v17 == 0) {
            sp60 = func_002b2970(280.0f + sp68.x, sp68.y);
            func_002b69f0(arg1, sp68, sp60, 0, 0x32, 0);
        } else if (v17 == 1) {
            f20 = 20.0f + ((y = sp68.y), y);
            sp58 = func_002b2970(280.0f + sp68.x, f20);
            sp50 = func_002b2970(sp68.x, f20);
...
void func_00324f80(u8 *arg0, FclVec2 arg1, s32 arg2, s8 arg3) {
    ...
    if (v17 == 0) {
        if ((s8)arg3 == 1) {
            ...
            sp70.position = func_002b2970(arg1.x, arg1.y);
        ...
        if ((s8)arg3 == 1) {
            ...
            sp68.position = func_002b2970(arg1.x, arg1.y);
    ...
    if (arg3 == 1) {
        ...
        f20 = arg1.y;
        sp60.position = func_002b2970(arg1.x, 176.0f + f20);
        func_002b6c30(0xAD, sp60.position, 169.0f, 0x41);
        if (v17 == 1) {
            sp58.position = func_002b2970(arg1.x, 194.0f + f20);
    ...
    if (arg3 == 1) {
        ...
        sp50.position = func_002b2970(arg1.x, arg1.y);
    ...
    sp48.position = func_002b2970(arg1.x, 52.0f + arg1.y);
...
void func_00329310(u8 *arg0, s16 arg1, s8 arg2) {
    ...
    task = *(u8 **)(arg0 + 0x38);
    constructedOrigin = func_002b2970(18.0f, 14.0f);
    *(FclVec2 *)origin = constructedOrigin;
    ...
    while (index < limit) {
        ...
        savedColumn = column;
        position = func_002b2970(baseX + (f32)((s32)savedColumn * 61) + *(f32 *)((u8 *)D_007495C0 + tableOffset), baseY);
        *(FclVec2 *)(func_002b6150(resource) + 0x38) = position;
        ...
        if (savedIndex >= 3 && index != 12) {
            ...
            s16 secondary;
            s16 secondaryShadow;
            position = func_002b2970(fclRowAdjustedX(position.x, D_00749600, tableOffset), 15.0f + position.y);
            group = column * 3;
...
void func_003297f0(f32 fparg0, f32 fparg1, u8 *arg0, s64 arg1, s8 arg2) {
    ...
    f32 *bounds;
    bounds = D_006440B8;
    spD0 = func_002b2970(fparg0, bounds[1]);
    t16 = (s8)arg2;
    if (t16 == 0) {
        ...
        p = func_002b6150(0x69);
        *(FclByte4 *)(p + 0x85) = cDC;
        spC0 = func_002b2970(spD0.x + fparg1, bounds[1]);
        spB8 = func_002b2970(spD0.x, bounds[1]);
        func_002b69f0(0x69, spC0, spB8, 0, 8, 0);
    } else {
        p = func_002b6150(0x69);
        spB0 = func_002b2970(spD0.x + fparg1, bounds[1]);
        func_002b69f0(0x69, *(FclVec2 *)(p + 0x38), spB0, 0, 8, 0);
    }
    spC8 = func_002b2970(17.0f + spD0.x, 9.0f + spD0.y);
    if (t16 == 0) {
...
/* Native color results retain the initial copies and later recoloring.
   The draw-call order is preserved.
...
void func_0032a960(u8 *arg0, s8 arg1) {
    ...
    u8 *p;
    (void)arg0;
    sp40 = func_002b2970(22.0f, 78.0f);
    {
        f32 x = sp40.x;
        f32 y = sp40.y;
        origin.x = x;
    ...
    sp48 = func_002b2970(origin.x, 293.0f + origin.y);
    if ((s8)arg1 == 0) {
    ...
    f21 = 23.0f + origin.y;
    sp48 = func_002b2970(15.0f + origin.x, f21);
    if ((s8)arg1 == 0) {
    ...
    sp48 = func_002b2970(285.0f + origin.x, f21);
    if ((s8)arg1 == 0) {
    ...
    f22 = 11.0f + origin.x;
    sp48 = func_002b2970(f22, 13.0f + origin.y);
    if ((s8)arg1 == 0) {
    ...
    sp48 = func_002b2970(f22, 306.0f + origin.y);
    if ((s8)arg1 == 0) {
...
void func_0032b000(u8 *arg0, s8 arg1) {
    ...
    u8 *p;
    (void)arg0;
    spC0 = func_002b2970(266.0f, (f32)0x163);
    {
        f32 x = spC0.x;
        f32 y = spC0.y;
        origin.x = x;
...
void func_0032b770(u8 *arg0, s32 arg1, s32 arg2, s8 arg3)
{
  ...
  while (((s16) i) < v2)
  {
    spC0 = func_002b2970(162.0f, 111.0);
    ;
    ;
  ...
  spB8 = func_002b2970(472.0f, 112.0f);
  func_00324f80(arg0, spB8, 0, arg3);
...
void func_0032b9d0(u8 *arg0, s16 arg1, s16 arg2, s8 arg3) {
    ...
    for (; entry < end; entry++, row++) {
        ...
        t2 = *(u8 **)(arg0 + 0x38);
        spC8 = func_002b2970(390.0f, 151.0f);
        cell = *(FclVec2 *)&spC8;
...
void func_0032f060(u8 *arg0, s32 arg1) {
    ...
    v16 = (s8)arg1;
    if (v16 == 0) {
        sp50.position = func_002b2970(p[0], p[1]);
    ...
    p = D_00644888;
    if (v16 == 0) {
        sp48.position = func_002b2970(p[0], p[1]);
    ...
    p = D_00644890;
    if (v16 == 0) {
        sp40.position = func_002b2970(p[0], p[1]);
    ...
    p = D_00644898;
    if (v16 == 0) {
        sp38.position = func_002b2970(p[0], p[1]);
    ...
    if (v16 == 0) {
        sp30.position = func_002b2970(0.0f, 65.0f);
...
/* 1368/1376 bytes, 22 resolved relocations and eight zero alignment bytes.
   ...
   Each row position is constructed into a compiler temporary (0xA0 down to
   0x78) and copied into the table. The frame holds only five table entries
   below those temporaries, although six rows are added when both flags are
   set: retail's own latent overflow, reproduced as written. */
typedef union {
    FclByte4 channels;
    u32 bits;
} FclColor0032f4d0;
...
void func_0032f4d0(u8 *arg0) {
    ...
    *(s8 *)(t + 0xB7) = 0;
    ...
    tbl[*(s8 *)(t + 0xB7)] = func_002b2970(26.0f, (f32)(*(s8 *)(t + 0xB7) * 34 + 0x57));
    *(s8 *)(t + 0xB7) += 1;
    ...
    if (datGetFlag(0x1305) != 0) {
        ...
        *(s8 *)(t + 0xB7) += 1;
        if (datGetFlag(0x1306) != 0) {
            ...
            tbl[*(s8 *)(t + 0xB7)] = func_002b2970(26.0f, 20.0f + (f32)(*(s8 *)(t + 0xB7) * 34 + 0x57));
            *(s8 *)(t + 0xB7) += 1;
            f20 = -14.0f;
        }
    }
    fclStoreId0032f4d0(0x16D, *(s8 *)(t + 0xB7) * 2, t);
    tbl[*(s8 *)(t + 0xB7)] = func_002b2970(26.0f, f20 + (f32)(*(s8 *)(t + 0xB7) * 34 + 0x57));
    *(s8 *)(t + 0xB7) += 1;
...
void func_00330060(u8 *arg0, s32 arg1) {
    ...
    *(u8 *)(t + 0x13A) = 1;
    ...
    while (cur < lim) {
        ...
        position = func_002b2970(32.0f, (f32)(savedColumn * 34 + 0x5B));
