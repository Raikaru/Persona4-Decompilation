...
void func_0033c490(u8 *arg0)
{
    ...
    if (*(s8 *)(p + 2) == 1) {
        ...
        func_0033d320(*(s32 *)(p + 0x120), 0, 1);
        func_0033d320(*(s32 *)(p + 0x124), 0, 1);
        func_0033d320(*(s32 *)(p + 0xDC), 0, 0);
        func_0033d320(*(s32 *)(p + 0xE0), 0, 0);
        func_0033d320(*(s32 *)(p + 0x6C), 0, 1);
        func_0033d320(*(s32 *)(p + 0x70), 0, 0);
        func_0033d320(*(s32 *)(p + 0xD8), 0, 0);
    } else {
        func_0033d320(*(s32 *)(p + 0xDC), 0, 1);
        func_0033d320(*(s32 *)(p + 0xE0), 0, 1);
        func_0033d320(*(s32 *)(p + 0x6C), 0, 0);
        func_0033d320(*(s32 *)(p + 0x70), 0, 1);
        func_0033d320(*(s32 *)(p + 0xD8), 0, 1);
        func_0033d320(*(s32 *)(p + 0x120), 0, 0);
        tbl = D_0064A2B0;
        f20v = tbl[0];
