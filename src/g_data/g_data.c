...
extern u32 datCalcGetHp(void* arg0);
extern u32 datCalcGetSp(void* arg0);
struct DatUnit;
extern u16 func_00231f80(struct DatUnit* unit);
extern u16 func_00232290(struct DatUnit* unit);
extern void datCalcGetBadStatusNoDown(void* arg0);
extern void func_00231dc0(void* arg0, s16 arg1);
extern void datCalcSetBadStatus(void* arg0);
...
extern void sprintf(void* dst, void* fmt, void* value, void* extra);

extern void H_Cdvd_ReadSync(u8* ptr);
...
void* func_00104900(s32 arg0)
{
    ...
    memcpy(new, (u8*)iGpffffb1ac + idx, 0x10);
    *(u32*)(new + 8) = (u32)new + 0x10;
    *(u32*)(new + 0xC) = *(u32*)(new + 8) + *(u32*)(new + 0) * 32;
    memcpy(*(void**)(new + 8), *(void**)(idxFirst(idx, (u8*)iGpffffb1ac) + 8), *(u32*)(new + 0) * 32);
    memcpy(*(void**)(new + 0xC), *(void**)(idxFirst(idx, (u8*)iGpffffb1ac) + 0xC), *(u32*)(new + 4) * 16);
    return new;
}
...
void func_00104a60(void)
{
    ...
    *(u32*)((u8*)iGpffffb1ac + 0xC) = *(u32*)((u8*)iGpffffb1ac + 8) + *(u32*)((u8*)iGpffffb1ac + 0) * 32;
    dst = src + 0x20;
    memcpy(*(void**)((u8*)iGpffffb1ac + 8), dst, *(u32*)((u8*)iGpffffb1ac + 0) * 32);
    dst = dst + *(u32*)((u8*)iGpffffb1ac + 0) * 32;
    memcpy(*(void**)((u8*)iGpffffb1ac + 0xC), dst, *(u32*)((u8*)iGpffffb1ac + 4) * 16);
    ...
    *(u32*)((u8*)iGpffffb1ac + 0x1C) = *(u32*)((u8*)iGpffffb1ac + 0x18) + *(u32*)((u8*)iGpffffb1ac + 0x10) * 32;
    ...
    memcpy(*(void**)((u8*)iGpffffb1ac + 0x18), dst, *(u32*)((u8*)iGpffffb1ac + 0x10) * 32);
    memcpy(*(void**)((u8*)iGpffffb1ac + 0x1C), dst + *(u32*)((u8*)iGpffffb1ac + 0x10) * 32, *(u32*)((u8*)iGpffffb1ac + 0x14) * 16);
    H_Cdvd_Destroy(obj);
}
...
u32 func_00104ce0(s16 arg0)
{
    if (arg0 == 1)
    {
        return datCalcGetHp(D_007973C4);
    }
    else
    {
        return datCalcGetHp((u8*)D_00796E50 + (arg0 - 2) * 0x88 + 4);
    }
}
...
u32 func_00104d50(s16 arg0)
{
    if (arg0 == 1)
    {
        return datCalcGetSp(D_007973C4);
    }
    else
    {
        return datCalcGetSp((u8*)D_00796E50 + (arg0 - 2) * 0x88 + 4);
    }
}
...
void func_00105340(s16 arg0)
{
    if (arg0 == 1)
    {
        datCalcGetBadStatusNoDown(D_007973C4);
    }
    else
    {
        datCalcGetBadStatusNoDown((u8*)D_00796E50 + (arg0 - 2) * 0x88 + 4);
    }
}
...
void func_00105780(s16 arg0)
{
    ...
    if (arg0 == 1)
    {
        r = datCalcGetHp(D_007973C4);
    }
    else
    {
        r = datCalcGetHp((u8*)D_00796E50 + (arg0 - 2) * 0x88 + 4);
    }
    v1 = (u16)r;
    if (arg0 == 1)
    {
    ...
    if (arg0 == 1)
    {
        r = datCalcGetSp(D_007973C4);
    }
    else
    {
        r = datCalcGetSp((u8*)D_00796E50 + (arg0 - 2) * 0x88 + 4);
    }
    v1 = (u16)r;
    if (arg0 == 1)
    {
...
void func_00105ce0(s16 arg0, s16 arg1)
{
    if (arg0 == 1)
    {
        datCalcSetBadStatus(D_007973C4);
    }
    else
    {
        datCalcSetBadStatus((u8*)D_00796E50 + (arg0 - 2) * 0x88 + 4);
    }
}
...
level_done:
    ...
    memcpy(buffer + 4, &summary, 52);
    records = buffer + 56;
    tag = 1;
    memcpy(records, &tag, 4);
    length = 36;
    memcpy(buffer + 60, &length, 4);
    memcpy(buffer + 64, D_007973A0, 36);
    tag = 2;
    memcpy(buffer + 100, &tag, 4);
    length = 72;
    memcpy(buffer + 104, &length, 4);
    memcpy(buffer + 108, D_007973C4, 72);
    tag = 3;
    memcpy(buffer + 180, &tag, 4);
    length = 344;
    memcpy(buffer + 184, &length, 4);
    memcpy(buffer + 188, D_0079740C, 344);
    tag = 4;
    memcpy(buffer + 532, &tag, 4);
    length = 16;
    memcpy(buffer + 536, &length, 4);
    memcpy(buffer + 540, D_00797564, 16);
    tag = 5;
    memcpy(buffer + 556, &tag, 4);
    length = 6;
    memcpy(buffer + 560, &length, 4);
    memcpy(buffer + 564, D_00797574, 6);
    tag = 6;
    memcpy(buffer + 570, &tag, 4);
    length = 1536;
    memcpy(buffer + 574, &length, 4);
    memcpy(buffer + 578, D_0079757A, 1536);
    tag = 8;
    memcpy(buffer + 2114, &tag, 4);
    length = 2;
    memcpy(buffer + 2118, &length, 4);
    memcpy(buffer + 2122, D_00797B7A, 2);
    tag = 9;
    memcpy(buffer + 2124, &tag, 4);
    length = 1;
    memcpy(buffer + 2128, &length, 4);
    memcpy(buffer + 2132, D_00797B7C, 1);
    tag = 10;
    memcpy(buffer + 2133, &tag, 4);
    length = 4;
    memcpy(buffer + 2137, &length, 4);
    memcpy(buffer + 2141, D_00797B80, 4);
    tag = 11;
    memcpy(buffer + 2145, &tag, 4);
    length = 2;
    memcpy(buffer + 2149, &length, 4);
    memcpy(buffer + 2153, D_00797B84, 2);
    tag = 12;
    memcpy(buffer + 2155, &tag, 4);
    length = 1;
    memcpy(buffer + 2159, &length, 4);
    memcpy(buffer + 2163, D_00797B86, 1);
    tag = 13;
    memcpy(buffer + 2164, &tag, 4);
    length = 1024;
    memcpy(buffer + 2168, &length, 4);
    memcpy(buffer + 2172, D_00797B87, 1024);
    tag = 14;
    memcpy(buffer + 3196, &tag, 4);
    length = 2;
    memcpy(buffer + 3200, &length, 4);
    memcpy(buffer + 3204, D_00797F88, 2);
    tag = 15;
    memcpy(buffer + 3206, &tag, 4);
    length = 576;
    memcpy(buffer + 3210, &length, 4);
    memcpy(buffer + 3214, D_00797F8C, 576);
    tag = 16;
    memcpy(buffer + 3790, &tag, 4);
    length = 12288;
    memcpy(buffer + 3794, &length, 4);
    memcpy(buffer + 3798, D_007981CC, 12288);
    tag = 17;
    memcpy(buffer + 16086, &tag, 4);
    length = 704;
    memcpy(buffer + 16090, &length, 4);
    memcpy(buffer + 16094, D_0079B1CC, 704);
    tag = 18;
    memcpy(buffer + 16798, &tag, 4);
    length = 4;
    memcpy(buffer + 16802, &length, 4);
    memcpy(buffer + 16806, D_0079B68C, 4);
    tag = 19;
    memcpy(buffer + 16810, &tag, 4);
    length = 8;
    memcpy(buffer + 16814, &length, 4);
    memcpy(buffer + 16818, D_0079B690, 8);
    tag = 21;
    memcpy(buffer + 16826, &tag, 4);
    length = 4;
    memcpy(buffer + 16830, &length, 4);
    memcpy(buffer + 16834, D_0079B698, 4);
    tag = 22;
    memcpy(buffer + 16838, &tag, 4);
    length = 4;
    memcpy(buffer + 16842, &length, 4);
    memcpy(buffer + 16846, D_0079B69C, 4);
    tag = 23;
    memcpy(buffer + 16850, &tag, 4);
    length = 4;
    memcpy(buffer + 16854, &length, 4);
    memcpy(buffer + 16858, D_0079B6A0, 4);
    tag = 24;
    memcpy(buffer + 16862, &tag, 4);
    length = 340;
    memcpy(buffer + 16866, &length, 4);
    memcpy(buffer + 16870, D_0079BCD8, 340);
    tag = 25;
    memcpy(buffer + 17210, &tag, 4);
    length = 512;
    memcpy(buffer + 17214, &length, 4);
    memcpy(buffer + 17218, D_0079B48C, 512);
    tag = 26;
    memcpy(buffer + 17730, &tag, 4);
    length = 1536;
    memcpy(buffer + 17734, &length, 4);
    memcpy(buffer + 17738, D_0079B6D8, 1536);
    tag = 27;
    memcpy(buffer + 19274, &tag, 4);
    length = 52;
    memcpy(buffer + 19278, &length, 4);
    memcpy(buffer + 19282, D_0079B6A4, 52);
    tag = 34;
    memcpy(buffer + 19334, &tag, 4);
    length = 1;
    memcpy(buffer + 19338, &length, 4);
    memcpy(buffer + 19342, D_00797B7C, 1);
    tag = 35;
    memcpy(buffer + 19343, &tag, 4);
    length = 4;
    memcpy(buffer + 19347, &length, 4);
    memcpy(buffer + 19351, D_0079BEF4, 4);
    cursor = buffer + 19355;
    total += 19355;
    if (compact == 0) {
        tag = 37;
        memcpy(cursor, &tag, 4);
        length = 4;
        memcpy(cursor + 4, &length, 4);
        memcpy(cursor + 8, &iGpffffb1b4, 4);
        tag = 38;
        memcpy(cursor + 12, &tag, 4);
        length = 4;
        memcpy(cursor + 16, &length, 4);
        memcpy(cursor + 20, &iGpffffb1b8, 4);
        tag = 39;
        memcpy(cursor + 24, &tag, 4);
        length = 86016;
        memcpy(cursor + 28, &length, 4);
        memcpy(cursor + 32, D_007BBF00, 86016);
        cursor += 0x15020;
        total += 0x15020;
    }
    tag = 40;
    ...
    length = 200;
    memcpy(cursor + 4, &length, 4);
    memcpy(cursor + 8, D_0079BE2C, 200);
    tag = 41;
    memcpy(cursor + 208, &tag, 4);
    length = func_0015a6a0();
    memcpy(cursor + 212, &length, 4);
    cursor += 216;
    eventEnd = total + 216;
    memcpy(cursor, func_0015a690(), func_0015a6a0());
    ...
    for (unitIndex = 0; unitIndex < 10; unitIndex++) {
        ...
        memcpy(cursor + 8, unit, 4);
        tag = (unitIndex << 8) + 257;
        memcpy(cursor + 12, &tag, 4);
        length = 72;
        memcpy(cursor + 16, &length, 4);
        memcpy(cursor + 20, unit + 4, 72);
        tag = (unitIndex << 8) + 258;
        memcpy(cursor + 92, &tag, 4);
        length = 6;
        memcpy(cursor + 96, &length, 4);
        memcpy(cursor + 100, unit + 76, 6);
        tag = (unitIndex << 8) + 261;
        memcpy(cursor + 106, &tag, 4);
        length = 48;
        memcpy(cursor + 110, &length, 4);
        memcpy(cursor + 114, unit + 84, 48);
        tag = (unitIndex << 8) + 267;
        memcpy(cursor + 162, &tag, 4);
        length = 4;
        memcpy(cursor + 166, &length, 4);
        memcpy(cursor + 170, unit + 132, 4);
        cursor += 174;
        total += 174;
    }
    checksum = 0;
    ...
    length = 1;
    memcpy(cursor + 4, &length, 4);
    memcpy(cursor + 8, &checksum, 1);
    tag = -1;
    memcpy(cursor + 9, &tag, 4);
    *outSize = total + 13;
...
void func_0010e710(s32 arg0, u8 *arg1, s32 arg2)
{
    ...
    memset(DAT_00796de0, 0, 0x12);
    memset(DAT_00796e00, 0, 0x12);
    memset(DAT_00796e20, 0, 0x24);
    memcpy(DAT_00796de0, DAT_007973a0, 0x12);
    memcpy(DAT_00796e00, DAT_007973b2, 0x12);
    sprintf(DAT_00796e20, &iGpffff9bb0, DAT_00796e00, DAT_00796de0);
}
...
void func_0010e9e0(s32 arg0, u32 arg1, u32 arg2, u8* arg3)
{
    ...
    case 1:
        if (arg2 == 36)
            memcpy(D_007973A0, arg3, 36);
        break;
    case 2:
        if (arg2 == 72)
            memcpy(D_007973C4, arg3, 72);
        break;
    case 3:
        if (arg2 == 344)
            memcpy(D_0079740C, arg3, 344);
        break;
    case 4:
        if (arg2 == 16)
            memcpy(D_00797564, arg3, 16);
        break;
    case 5:
        if (arg2 == 6)
            memcpy(D_00797574, arg3, 6);
        break;
    case 6:
        if (arg2 == 1536)
            memcpy(D_0079757A, arg3, arg2);
        break;
    case 8:
        if (arg2 == 2)
            memcpy(D_00797B7A, arg3, arg2);
        break;
    case 9:
        if (arg2 == 1)
            memcpy(D_00797B7C, arg3, arg2);
        break;
    case 10:
        if (arg2 == 4)
            memcpy(D_00797B80, arg3, arg2);
        break;
    case 11:
        if (arg2 == 2)
            memcpy(D_00797B84, arg3, arg2);
        break;
    case 12:
        if (arg2 == 1)
            memcpy(D_00797B86, arg3, arg2);
        break;
    case 13:
        if (arg2 == 1024)
            memcpy(D_00797B87, arg3, arg2);
        break;
    case 14:
        if (arg2 == 2)
            memcpy(D_00797F88, arg3, arg2);
        break;
    case 15:
        if (arg2 == 576)
            memcpy(D_00797F8C, arg3, arg2);
        break;
    case 16:
        if (arg2 == 12288)
            memcpy(D_007981CC, arg3, arg2);
        break;
    case 17:
        if (arg2 == 704)
            memcpy(D_0079B1CC, arg3, arg2);
        break;
    case 18:
        if (arg2 == 4)
            memcpy(D_0079B68C, arg3, arg2);
        break;
    case 19:
        if (arg2 == 8)
            memcpy(D_0079B690, arg3, arg2);
        break;
    case 21:
        if (arg2 == 4)
            memcpy(D_0079B698, arg3, arg2);
        break;
    case 22:
        if (arg2 == 4)
            memcpy(D_0079B69C, arg3, arg2);
        break;
    case 23:
        if (arg2 == 4)
            memcpy(D_0079B6A0, arg3, arg2);
        break;
    case 24:
        if (arg2 == 340)
            memcpy(D_0079BCD8, arg3, arg2);
        break;
    case 25:
        if (arg2 == 512)
            memcpy(D_0079B48C, arg3, arg2);
        break;
    case 26:
        if (arg2 == 1536)
            memcpy(D_0079B6D8, arg3, arg2);
        break;
    case 27:
        if (arg2 == 52)
            memcpy(D_0079B6A4, arg3, arg2);
        break;
    case 32:
        break;
    case 34:
    ...
    case 35:
        if (arg2 == 4)
            memcpy(D_0079BEF4, arg3, arg2);
        break;
    case 37:
        if (arg2 == 4)
            memcpy(&iGpffffb1b4, arg3, arg2);
        break;
    case 38:
        if (arg2 == 4)
            memcpy(&iGpffffb1b8, arg3, arg2);
        break;
    case 39:
        if (arg2 == 86016)
            memcpy(D_007BBF00, arg3, arg2);
        break;
    case 40:
        if (arg2 == 200)
            memcpy(D_0079BE2C, arg3, arg2);
        break;
    case 41:
        if (arg2 == func_0015a6a0())
            memcpy(func_0015a690(), arg3, arg2);
        break;
    case 0x100:
    case 0x200:
    case 0x300:
    ...
    case 0xa00:
        index = arg1 >> 8;
        if (arg2 == 4)
            memcpy(D_00796E50 + (index - 1) * 0x88, arg3, arg2);
        break;
    case 0x101:
    case 0x201:
    case 0x301:
    ...
    case 0xa01:
        index = arg1 >> 8;
        if (arg2 == 72)
            memcpy(D_00796E50 + (index - 1) * 0x88 + 4, arg3, arg2);
        break;
    case 0x102:
    case 0x202:
    case 0x302:
    ...
    case 0xa02:
        index = arg1 >> 8;
        if (arg2 == 6)
            memcpy(D_00796E50 + (index - 1) * 0x88 + 76, arg3, arg2);
        break;
    case 0x105:
    case 0x205:
    case 0x305:
    ...
    case 0xa05:
        index = arg1 >> 8;
        if (arg2 == 48)
            memcpy(D_00796E50 + (index - 1) * 0x88 + 84, arg3, arg2);
        break;
    }
}
...
// FUN_0010F560
u16 func_0010f560(s16 arg0, s32 arg1)
{
    u8* p;
...
void func_0010fd40(u8* src)
{
    ...
    memcpy((u8*)DAT_007973a0 + *(u16*)(src + 2) * 48 + 0xE2C, src, 0x30);
}
...
u8* func_0010fde0(u8* arg0)
{
    ...
    v = *(u16*)(arg0 + 2);
    memcpy((u8*)D_007973A0 + v * 0x30 + 0xE2C, arg0, 0x30);
    return NULL;
}
            ...
            !(*(u16 *)(base + id * 0xE) & 0x20))
        {
            ...
            }
            {
                ...
                if (q == NULL)
                {
                    ...
                    memcpy((u8 *)DAT_007973a0 + (s32)*(u16 *)(buf + 2) * 0x30 + 0xE2C, buf, 0x30);
                }
            }
        }
        i = i + 1;
