...
/* Residual: retail sb $a1,4($a2) vs candidate sb $v0,4($a2); retail sb $v0,7($a2) vs candidate sb $a1,7($a2); retail addu $v1,$v0,$v1 vs candidate addu $v1,$v1,$v0. Probed census declaration corrections, final-address operand/helper spellings, color-load production/mapping/declaration orders, local widths/signedness, direct/pointer stores, and inline store helpers; best remained nd 3. */
