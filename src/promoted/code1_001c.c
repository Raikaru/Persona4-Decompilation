...
void func_001c1f70(u8 *arg0)
{
    ...
    if ((*(u16 *)(temp_4 + 0x1A) & 0x10) != 0) {
        ...
        func_003dcb40((s64 *)&frame.valueA0,
                      (s64 *)((u8 *)temp_16 + 4),
                      1, temp_17 + 0x1C);
        func_003dcb40((s64 *)&frame.value90,
                      (s64 *)((u8 *)temp_16 + 0x1C),
                      1, temp_17 + 0x1C);
        ...
        func_001bac20(iGpffffb3ac + 0x24, &frame.value50,
                      &frame.value6C, 1);
        temp_2 = *temp_16;
...
s32 func_001c88d0(u8 *arg0, s32 *arg1, f32 *arg2, u8 *arg3)
{
    ...
    func_003e4320((u8 *)&frame.value70, D_0060A0D0, arg3);
...
void func_001ce470(u8 *arg0)
{
    ...
    if (*(s32 *)(arg0 + 0xD8) == 0) {
        ...
        *(struct Vec3 *)&frame.value2C =
        ...
        func_001bac20(iGpffffb3ac + 0x24,
                      &frame.value10, vector, 1);
...
void func_001cf1f0(u8 *arg0)
{
    ...
    func_00195850(*(u8 **)(*(u8 **)(iGpffffb3ac + 0x170) + 0x30),
                  &frame.vec90[0]);
    frame.vec90[1] = 0.0f;
    func_003e0870((u8 *)&frame, D_0060A0D0, -30.0f, 0);
    func_003e0870((u8 *)&frame, D_0060A0E0,
                  *(f32 *)(arg0 + 0x100), 2);
    func_003e4320((u8 *)&frame.vec80[0], D_0060A0F0,
                  (u8 *)&frame);
...
void func_001cf350(u8 *arg0)
{
    ...
    temp_f1 = 0.25f * func_003e40b0(&frame.sp100, &frame.sp100);
    ...
    temp_f20 = var_f21 / func_0044b868(fGpffff8110 *
                                         (0.5f * *(f32 *)(arg0 + 0xB8)));
    func_003e0870(frame.sp80, D_0060A0D0, 32.5f, 0);
    ...
    temp_f1 = temp_f20 * func_0044b868(fGpffff8110 *
                                         (0.5f * *(f32 *)(arg0 + 0xB8)));
