...
extern void resrcMngDestroy(u8 *arg0);
extern u8 *resrcMngGetListHead(u8 *arg0, s32 arg1);
...
extern u8 *resrcMngCreateRes(s32 arg0, s32 arg1);
...
extern void memcpy(void *dest, const void *src, s32 size);
...
extern s32 resrcMngCreate(void);
extern s32 MT_Scene_CreateResLightChar(s32 arg0);
extern void func_0014ad90(void);
extern s32 MT_Scene_CreateResLightNpc(s32 arg0);
...
extern void strcat(void *arg0, const void *arg1);
...
/* MATCHED: same menu state machine as func_003627b0, func_0035e8b0, func_0035f0c0 and func_0013d8b0 - `*arg1 = (resultFlag = 1);`, switch on u32 `*arg0` (sltiu) breaking to shared `return 0`, fade returning 2. Party-slot address uses `p4_00141cf0_add` for retail's index-then-base `addu`; 7-word copy uses temp-split `tmp = *src++; n--; *dst++ = tmp;` for retail's load-decrement-store schedule; func_00141cf0 third param is s32 (word `lw`, low 16 stored) and func_00355190 second is s32 (hoisted `lhu` before `lw`), both value-preserving and precedent-backed. */
// FUN_00142F20
    ...
    *arg1 = (resultFlag = 1);
    ...
    case 0:
        ...
        *arg1 = 0;
        break;
    case 1:
        if ((func_0013ff80(arg2) & func_0034c210()) != 0) {
            *arg0 = 3;
            func_0034bb20(0x15);
        } else {
            *arg1 = 0;
    ...
    case 3:
        if (func_00142340(arg2) != 0) {
            func_00141d80(arg2, 2);
            *arg0 = 4;
            func_00353fe0();
            func_00142d80(*(u8 **)(arg2 + 0x3C), 0, 1, 0);
        }
        break;
    case 4:
        if (D_008C024E[0] & 0x20) {
            func_00141d80(arg2, 1);
            *arg0 = 2;
            func_00353fb0();
            func_0034bb20(0x17);
            func_00142d80(*(u8 **)(arg2 + 0x3C), 0, 0, 1);
            ...
            s32 n4;
            s32 tmp4;
            func_00141d80(arg2, 3);
            func_00142090(arg2);
            *arg0 = 5;
            func_0034bb20(0x16);
            base4 = arg2 + 0x1878;
            func_003671d0(base4);
            func_003672d0(base4, *(s16 *)(p4_00141cf0_add((u32)(*(s16 *)(arg2 + 0x34) * 2), arg2) + 0x22));
            lsrc4 = (s32 *)(arg2 + 0x1878);
            ldst4 = (s32 *)(arg2 + 0x1894);
            n4 = 7;
            do {
                tmp4 = *lsrc4++;
                n4--;
            ...
            func_00142d80(*(u8 **)(arg2 + 0x3C), 1, 0, 0);
            func_0045af60(0, 0, 0, 1);
        } else if (D_008C024E[0] & 0x10) {
            *(s32 *)(arg2 + 0x10) = func_00354030();
            *arg0 = 9;
        } else {
            func_00453670(query, *(s16 *)(arg2 + 0x32), *(s16 *)(arg2 + 0x32), *(s16 *)(arg2 + 0x34), 0);
            func_004538e0(query, 0x4000, 0x1000, 0, 0);
            if (func_00453960(query) != 0) {
                func_00141cf0(arg2, 0, *(s32 *)(query + 0x24));
                func_00355190(*(u8 **)(arg2 + 0x3C), *(u16 *)(p4_00141cf0_add((u32)(*(s16 *)(arg2 + 0x34) * 2), arg2) + 0x22));
    ...
    case 5:
        if (func_00142340(arg2) != 0) {
            func_00141d80(arg2, 4);
            *arg0 = 6;
            func_00142d80(*(u8 **)(arg2 + 0x3C), 2, 1, 0);
        }
        break;
    case 6:
        if (D_008C024E[0] & 0x20) {
            ...
            *arg0 = 3;
            func_0034bd60(0x15);
            func_00142d80(*(u8 **)(arg2 + 0x3C), 2, 0, 1);
            func_0045af60(0, 0, 0, 2);
        } else if (D_008C024E[0] & 0x10) {
            *(s32 *)(arg2 + 0x10) = func_00354030();
            *arg0 = 9;
        } else if (D_008C024E[0] & 0x80) {
            if (*(s16 *)(p4_00141cf0_add((u32)(*(s16 *)(arg2 + 0x34) * 2), arg2) + 0x22) == 1) {
                func_00141d80(arg2, 5);
                func_00142230(arg2);
                *arg0 = 7;
                func_0034bb20(0x18);
                func_00142d80(*(u8 **)(arg2 + 0x3C), 2, 0, 1);
            ...
            u8 *base6;
            func_00453670(query, *(s16 *)(arg2 + 0x32), *(s16 *)(arg2 + 0x32), *(s16 *)(arg2 + 0x34), 0);
            func_00453760(query, 0);
            func_004538e0(query, 8, 4, 0, 0);
            ...
            if (queryResult > 0) {
                ...
                lsrc6 = (s32 *)(arg2 + 0x1878);
                ldst6 = (s32 *)(arg2 + 0x1894);
                n6 = 7;
                do {
                    tmp6 = *lsrc6++;
                    n6--;
                ...
                base6 = arg2 + 0x1878;
                func_003671d0(base6);
                func_003672d0(base6, *(s16 *)(p4_00141cf0_add((u32)(*(s16 *)(arg2 + 0x34) * 2), arg2) + 0x22));
                if (*(s16 *)(p4_00141cf0_add((u32)(*(s16 *)(arg2 + 0x34) * 2), arg2) + 0x22) == 1) {
                    *(s16 *)(arg2 + 0x38) = 6;
                } else {
                    *(s16 *)(arg2 + 0x38) = 5;
    ...
    case 7:
        if (*(s16 *)(arg2 + 0x20) == 1) {
            func_00142d80(*(u8 **)(arg2 + 0x3C), 3, 1, 0);
        }
        if (func_00142340(arg2) != 0) {
            func_00141d80(arg2, 6);
            *arg0 = 8;
        }
        break;
    case 8:
        if (D_008C024E[0] & 0x80) {
            ...
            *arg0 = 5;
            func_0034bd60(0x16);
            func_00142d80(*(u8 **)(arg2 + 0x3C), 3, 0, 1);
            func_0045af60(0, 2, 0, 4);
        } else if (D_008C024E[0] & 0x10) {
            *(s32 *)(arg2 + 0x10) = func_00354030();
            *arg0 = 9;
...
s32 func_001441e0(u8 *arg0) {
    ...
    case 1:
        ...
        for (i = 0; i < 7; i++) {
            ...
            switch (v) {
            case 0:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9ce4);
                break;
            case 1:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9ce8);
                break;
            case 2:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9cf0);
                break;
            case 3:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9cf8);
                break;
            case 4:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d00);
                break;
            case 16:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d08);
                break;
            case 17:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d10);
                break;
            case 18:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d18);
                break;
            case 19:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d20);
                break;
            case 20:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d28);
                break;
            case 32:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d30);
                break;
            case 33:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d38);
                break;
            case 34:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d40);
                break;
            case 35:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d48);
                break;
            case 36:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d50);
                break;
            case 48:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d58);
                break;
            case 49:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d60);
                break;
            case 50:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d68);
                break;
            case 51:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d70);
                break;
            case 52:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d78);
                break;
            case 64:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d80);
                break;
            case 65:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d88);
                break;
            case 66:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d90);
                break;
            case 67:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9d98);
                break;
            case 68:
                H_Dbprt_FmtAt(pos.packed, &iGpffff9da0);
                break;
            }
        }
        for (i = 0; i < 7; i++) {
...
s32 func_00144b80(s32 arg0, s32 arg1)
{
    ...
    strcpy(path, (char *)D_005EF7C0);
    sprintf(part, (char *)&iGpffff9db8, arg0);
    strcat(path, part);
    sprintf(part, (char *)&iGpffff9dc0, arg1);
    strcat(path, part);
    strcat(path, &iGpffff9dc8);
...
loop_5_test:
    ...
    *(s32 *)(iGpffff9db0 + 8) = resrcMngCreate();
...
loop_13_test:
    ...
    if (temp_17 != 0) {
        ...
        goto loop_20_test;
loop_20_body:
        var_2 = resrcMngGetListHead(temp_17, var_16_3 & 0xFF);
        goto loop_18_test;
loop_18_body:
...
s32 func_001453a0(u16 arg0)
{
    ...
    temp_2 = resrcMngCreateRes(temp_4, temp_16);
    if (temp_2 == NULL) {
        return 0;
    }
    if (temp_2 == NULL) {
...
s32 func_00145690(u16 arg0, s32 arg1) {
    ...
    temp_2 = resrcMngCreateRes(temp_4, temp_17);
    if (temp_2 == NULL) {
        return 0;
    }
...
s32 func_00146440(u16 arg0, s32 arg1, f32 fparg0, u8 *arg2, u8 *arg3, u8 *arg4, f32 fparg1, f32 fparg2, s32 arg5, s32 arg6) {
    ...
    temp_2 = resrcMngCreateRes(temp_4, temp_22);
    if (temp_2 == NULL) {
        return 0;
    }
    ...
    *(f32 *)(temp_2 + 0x160) = fparg2;
    if (arg5 != 0) {
        memcpy(temp_2 + 0x164, (const void *)arg5, 0x20);
    }
    if (arg6 != 0) {
        memcpy(temp_2 + 0x184, (const void *)arg6, 0x180);
    }
    *(s32 *)(temp_2 + 0x28) = *(s32 *)(temp_2 + 0x28) | 8;
    return temp_22;
}
...
void func_00146a10(u8 *resource, u8 *position, u8 *rotation, u8 *scaleInput)
{
    ...
    extern void mdlScale(Model *model, const RwV3d *scale, s32 combineOp);
    ...
    if (resource != 0) {
        ...
        case 1:
            ...
            mdlScale((Model *)(u32)modelHandle, &scale, 2);
...
void func_00149ea0(void)
{
    ...
    *(s32 *)(var_16 + 0xC) = *(s32 *)(var_16 + 0xC) | 0x20003;
    ...
    stack[1] = 0x3F800000;
    stack[2] = 0;
    RwMatrixRotate(var_16, &stack[0], 2, -180.0f);
    stack[0] = 0x3F800000;
    stack[1] = 0;
    stack[2] = 0;
    RwMatrixRotate(var_16, &stack[0], 2, -45.0f);
}
...
void func_0014b1e0(void) {
    ...
    *(s32 *)(var_17 + 0xC) |= 0x20003;
    ...
    stack[1] = 0x3F800000;
    stack[2] = 0;
    RwMatrixRotate(var_17, &stack[0], 2, -180.0f);
    stack[0] = 0x3F800000;
    stack[1] = 0;
    stack[2] = 0;
    RwMatrixRotate(var_17, &stack[0], 2, -45.0f);
    *(s32 *)(var_16 + 0x28) = 0x3F800000;
    *(s32 *)(var_16 + 0x14) = 0x3F800000;
    *(s32 *)(var_16 + 0) = 0x3F800000;
    *(s32 *)(var_16 + 0x10) = 0;
...
u16 func_0014be50(u8 *arg0, u8 **arg1) {
    ...
    while (surface != NULL) {
        ...
        if ((K_FldFrame_IsPointInTriangle((f32 *)arg0, triangle, (f32 *)&normal) == 1) &&
...
u8 *func_0014c540(u8 *arg0, f32 fparg0, f32 fparg1) {
    ...
    extern s32 K_FldEvent_IsPosWithinFov(u8 *arg0, u8 *arg1, f32 fparg0);
    ...
    if (*saved_entry != 0) {
        if (K_FldEvent_IsPosWithinFov(mdlGetMatrix(*(s32 *)(arg + 0x50)),
            ...
            if (func_0016b540(&stack.v80, &stack.hitPoint) == 0) {
                temp_f0 = RwV3dLength(stack.diffB0);
...
void func_0014d290(u8 *arg0, u8 *arg1)
{
    ...
    while (var_16_2 < func_003bb330(*(u8 **)(arg1 + 0xC))) {
        ...
        primSphereLine3D((u8 *)sp40, 5.0f, (u8 *)&sp4C, 1);
        var_16_2 += 1;
    }
}
// FUN_0014D470
...
s32 func_0014e2a0(u8 *arg0) {
    ...
    case 0:
        if (*(s32 *)(temp_18 + 0xC) == 0) {
            if (H_Cdvd_IsFileLoaded(*(u8 **)(temp_18 + 4)) != 0) {
                temp_2 = *(u8 **)(temp_18 + 4);
                if (temp_2 != NULL) {
                    *(s32 *)(temp_18 + 0x14) =
                        func_004b1130(*(s32 *)(temp_2 + 0x110));
                    H_Cdvd_Destroy(*(u8 **)(temp_18 + 4));
                    *(u8 **)(temp_18 + 4) = NULL;
                }
                goto block_10;
            }
...
s32 func_0014e5e0(u8 *arg0, u8 *arg1, s32 arg2, s32 arg3) {
    ...
    *(s32 *)(temp_2 + 8) = arg2;
    strcpy(temp_2 + 0xBC, (const char *)arg1);
    return temp_17;
}
// FUN_0014E710
...
extern void H_Fade_SetCustomColor(s32 red, s32 green, s32 blue);
extern void RwV3dNormalize(f32 *destination, f32 *source);
            ...
            if (frame < 84) {
                if (frame > 40) {
                    ...
                    if (*(s32 *)(work + 4) == 1) {
                        ...
                        func_00122520(1, 1);
                        H_Fade_SetCustomColor(color[0], color[1], color[2]);
                        ++*(s32 *)work;
                    }
                }
                ++*(s32 *)(work + 8);
    ...
    *(s32 *)(temp_2 + 4) = arg1;
    if (arg1 == 0) {
        ...
        if (temp_2_2 == NULL) {
            ...
            *(s32 *)(temp_2_2 + 8) = 0x53;
            strcpy(temp_2_2 + 0xBC, (const char *)&D_005EFC40);
        }
        *(s32 *)(temp_2 + 0xC) = arg1;
    } else if (arg1 == 1) {
        func_0044ea90(&iGpffff9de0, 0xC2);
