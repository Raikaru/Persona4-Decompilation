...
/* measured: schedule-order probe for func_003561d0. */
...
void func_003561d0(s64 arg0, s32 arg1, s32 arg2, s32 arg3, f32 dummy, f32 f0, f32 f1)
{
    ...
    one = 1.0f;
    func_00365f00(dummy, scaled, shifted, one, *(s64 *)((u8 *)&frame.saved0), frame.saved1, frame.saved1, 4, var8, one);
}
/* measured: close schedule-order probe for func_003561d0. */
