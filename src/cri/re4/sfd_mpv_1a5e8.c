...
extern void *func_0043f9c8(void *dst, Sint32 val, Sint32 len);
...
Sint32 SFMPV_Init(void)
{
	...
	func_0043f9c8(sfmpv_para, 0, 0x24);
	func_0043f9c8(sfmpv_rfb_adr_tbl, 0, 8);
	func_0043f9c8(sfmpv_ta_adr_tbl, 0, 0x40);
