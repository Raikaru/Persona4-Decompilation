/* Retail CRI-block functions attributed to adx_tlk2.c.
 *
 * The donor-verbatim port of this translation unit, where one of the
 * reconstructed CRIWare or RenderWare source trees provides it, lives under
 * src/cri/<tree>/ or src/renderware/.  What is here is the retail code those
 * revisions do not reproduce: reconstructed bodies, INCLUDE_ASM fallbacks and
 * inline assembly.  Split out of the grouped holding pen by
 * local/split_grouped.py along the name-to-unit attribution
 * (docs/sky2/rw_unit_attribution.json, docs/cri/cri_unit_attribution.json).
