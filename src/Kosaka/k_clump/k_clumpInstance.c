...
s32 func_001921a0(u8 *arg0)
{
    ...
    {
    case 0:
        work->field_4 = func_00428550(D_005F6520);
        if (work->field_4 < 0)
        {
            return -1;
        }
        ...
        goto done;
    case 1:
        if (func_00428780(work->field_4, &work->field_8) > 0)
        {
            if (func_004426e8(work->name, &D_0076315C) != 0 &&
                func_004426e8(work->name, &D_00763160) != 0)
            {
                p = work->name;
                while (*p != 0x2E && *p != 0)
                {
                ...
                if (func_004426e8(p, &D_00763168) == 0)
                {
                    buf[0] = *(char *)((u8 *)work + 0x49);
                    buf[1] = *(char *)((u8 *)work + 0x4A);
                    buf[2] = *(char *)((u8 *)work + 0x4B);
                    buf[3] = 0;
                    if (func_0043c6b0(buf) < 0x14)
                    {
        ...
        goto done;
    case 2:
        func_00440b68(&D_00763170, D_005F6500, 0xEB);
        ...
        func_00442428(sp30, p + 1);
        func_00191e90(work->field_450, (s32 *)sp30, (u8 *)work);
    ...
    case 4:
        ...
        goto done;
    case 5:
        for (i = 0; i < (s32)work->count; i++)
        {
            if (work->items[i] != 0)
            {
                func_003c0700((void *)work->items[i]);
            }
        }
        work->state = 1;
        goto done;
