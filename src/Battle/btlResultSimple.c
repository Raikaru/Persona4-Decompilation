...
if ((*( u16 *)((u8 *)(w) + 0)) & 2) {
        ...
        vt[0](1, 0);
        func_00364c50();
        func_0045db40(&c11C, (u8 *)&sC0, 0.0f, 0, 0, 0, 45.0f, 1.0f, 1.0f);
        func_00364c70();
        ...
        func_0034f320((u8 *)(*(s32 *)(w + 0x448)), f110, f114, 10.0f, 0x2DU, 0x2DU, 0x2DU, b18, 0x1000, 0x1000, 0, 0.0f, (s64)0);
        f110 = (f32) 0x111 + (*(f32 *)(w + 0x170));
        f114 = (f32) 0x187 + (*(f32 *)(w + 0x174));
        func_0034f320((u8 *)(*(s32 *)(w + 0x44C)), f110, f114, 10.0f, 0x2DU, 0x2DU, 0x2DU, b18, 0x1000, 0x1000, 0, 0.0f, (s64)0);
        vt[0](6, 0);
        vt[0](6, 1);
        f110 =(76.0f + (*(f32 *)(w + 0x170)));
        f114 = (f32) 0x171 + (*(f32 *)(w + 0x174));
        func_0034f320((u8 *)(*(s32 *)(w + 0x434)), f110, f114, 10.0f, 0x2DU, 0x2DU, 0x2DU, b18, 0x1000, 0x1000, 0, 0.0f, (s64)0);
        if ((*( u16 *)((u8 *)(p16) + 8)) & 4) {
            c11C = 0;
            c11D = 0;
            c11E = 0;
        ...
        while (uD0.str[s19] != 0) {
            sidx = uD0.str[s19];
            func_0034f320((u8 *)(*( s32 *)((u8 *)(w + sidx * 4) + 0x390)), f110, f114, 10.0f, c11C, c11D, c11E, b18, 0x1000, 0x1000, 0, 0.0f, (s64)0);
            f110 += 16.0f;
            s19 += 1;
        }
        f110 =(157.0f + (*(f32 *)(w + 0x170)));
        f114 =((366.0f + (*(f32 *)(w + 0x174))) - 2.0f);
        func_00274ed0(f110, f114, 10.0f, (((u8)b18 & 0xFF) | ~0xFF), 5, 1, func_0010d6d0(1), 0, 0);
        vt[0](6, 0);
        if ((*( u16 *)((u8 *)(p16) + 8)) & 4) {
            c19 = 0x67;
            c18 = 0x5F;
...
loop_11:
        ...
        if ((*( u16 *)((u8 *)(p16) + 8)) & 4) {
            ...
            func_00364c50();
            func_0034f320((u8 *)w4B0, f110, f114, 0.0f, 0xFFU, 0xFFU, 0xFFU, b17, 0x1000, 0x1000, 0, -72.0f, (s64)0);
            func_00364c70();
            ...
            func_00364c50();
            func_0034f320((u8 *)w4B4, f110, f114, 0.0f, 0xFFU, 0xFFU, 0xFFU, b172, 0x1000, 0x1000, 0, -30.0f, (s64)0);
            func_00364c70();
...
if (2147483648.0f <= g14) {
            ...
            func_00364c50();
            func_0034f320((u8 *)w4B8, f110, f114, 0.0f, 0xFFU, 0xFFU, 0xFFU, b174, 0x1000, 0x1000, 0, 15.0f, (s64)0);
            func_00364c70();
