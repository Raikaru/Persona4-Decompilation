...
Canonical ownership and duplicate-marker protection live in test_reconcile.py.
These guards enforce the whole-file translation-unit model and reject scratch
code or malformed marker placement that can hide bodies from the verifier.
"""
